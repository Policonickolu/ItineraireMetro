...
var p_la_defense = [592*u,1414*u,20,0];
var p_esplanade_de_la_defense = [670*u,1492*u,20,0];
var p_pont_de_neuilly = [752*u,1575*u,20,0];
var p_les_sablons = [835*u,1658*u,20,0];
var p_porte_maillot = [928*u,1752*u,20,0];
var p_argentine = [1062*u,1885*u,20,0];
var p_charles_de_gaulle_etoile = [1166*u,1989*u,20,0];
var p_georges_v = [1294*u,2117*u,20,0];
var p_franklin_d_roosevelt = [1418*u,2240*u,-175,0];
var p_champs_elysees_clemenceau = [1507*u,2330*u,-125,25];
var p_concorde = [1583*u,2406*u,20,0];
var p_tuileries = [1774*u,2465*u,20,-10];
var p_palais_royal_musee_du_louvre = [1953*u,2465*u,-100,30];
var p_louvre_rivoli = [2099*u,2465*u,20,-10];
var p_chatelet = [2420*u,2476*u,15,-15];
var p_hotel_de_ville = [2599*u,2465*u,20,0];
var p_saint_paul = [2747*u,2616*u,20,0];
var p_bastille = [2940*u,2664*u,20,0];
var p_gare_de_lyon = [3124*u,3050*u,20,10];
var p_reuilly_diderot = [3332*u,2923*u,20,7];
var p_nation = [3600*u,2776*u,-60,0];
var p_porte_de_vincennes = [3773*u,2830*u,20,0];
var p_saint_mande = [3904*u,2904*u,20,0];
var p_berault = [3999*u,3000*u,20,0];
var p_chateau_de_vincennes = [4036*u,3035*u,20,0];
var p_porte_dauphine = [798*u,2008*u,20,0];
var p_victor_hugo = [951*u,2161*u,-100,20];
var p_ternes = [1279*u,1876*u,20,0];
var p_courcelles = [1376*u,1779*u,20,0];
var p_monceau = [1473*u,1683*u,20,0];
var p_villiers = [1569*u,1586*u,20,0];
var p_rome = [1677*u,1478*u,20,20];
var p_place_de_clichy = [1812*u,1448*u,20,-10];
var p_blanche = [2030*u,1448*u,20,-10];
var p_pigalle = [2251*u,1448*u,20,-10];
var p_anvers = [2418*u,1448*u,20,-10];
var p_barbes_rochechouart = [2619*u,1448*u,20,-10];
var p_la_chapelle = [2835*u,1448*u,20,-10];
var p_stalingrad = [3089*u,1481*u,20,0];
var p_jaures = [3193*u,1553*u,20,0];
var p_colonel_fabien = [3211*u,1708*u,20,0];
var p_belleville = [3211*u,1857*u,20,10];
var p_couronnes = [3304*u,1982*u,20,0];
var p_menilmontant = [3420*u,2097*u,20,0];
var p_pere_lachaise = [3528*u,2238*u,15,-15];
var p_philippe_auguste = [3528*u,2356*u,20,0];
var p_alexandre_dumas = [3528*u,2503*u,20,0];
var p_avron = [3542*u,2652*u,20,0];
var p_pont_de_levallois_becon = [1158*u,1174*u,20,0];
var p_anatole_france = [1211*u,1227*u,20,0];
var p_louise_michel = [1263*u,1279*u,20,0];
var p_porte_de_champerret = [1316*u,1332*u,20,0];
var p_pereire = [1393*u,1409*u,20,0];
var p_wagram = [1446*u,1462*u,20,0];
var p_malesherbes = [1507*u,1523*u,20,0];
var p_europe = [1680*u,1697*u,20,0];
var p_saint_lazare = [1801*u,1862*u,20,10];
var p_havre_caumartin = [1868*u,2017*u,20,0];
var p_opera = [1957*u,2106*u,20,10];
var p_quatre_septembre = [2059*u,2207*u,20,0];
var p_bourse = [2210*u,2260*u,20,-10];
var p_sentier = [2368*u,2260*u,20,-10];
var p_reaumur_sebastopol = [2575*u,2271*u,20,15];
var p_arts_et_metiers = [2825*u,2226*u,-100,-20];
var p_temple = [2895*u,2141*u,-70,0];
var p_republique = [2969*u,2098*u,20,-1];
var p_parmentier = [3313*u,2180*u,20,0];
var p_rue_saint_maur = [3404*u,2238*u,-30,30];
var p_gambetta = [3708*u,2238*u,-30,30];
var p_porte_de_bagnolet = [3890*u,2238*u,-40,-20];
var p_gallieni = [4021*u,2238*u,-20,-20];
var p_pelleport = [3819*u,2078*u,20,0];
var p_saint_fargeau = [3910*u,1931*u,20,0];
var p_porte_des_lilas = [3910*u,1790*u,20,0];
var p_porte_de_clignancourt = [2367*u,1074*u,20,0];
var p_simplon = [2434*u,1141*u,20,0];
var p_marcadet_poissonniers = [2498*u,1243*u,20,15];
var p_chateau_rouge = [2498*u,1332*u,20,10];
var p_gare_du_nord = [2840*u,1547*u,20,15];
var p_gare_de_l_est = [2840*u,1718*u,20,10];
var p_chateau_d_eau = [2721*u,1833*u,20,0];
var p_strasbourg_saint_denis = [2675*u,2038*u,20,-5];
var p_etienne_marcel = [2421*u,2304*u,20,20];
var p_les_halles = [2421*u,2387*u,20,0];
var p_cite = [2352*u,2605*u,20,0];
var p_saint_michel = [2293*u,2766*u,20,0];
var p_odeon = [2260*u,2852*u,20,-10];
var p_saint_germain_des_pres = [2078*u,2840*u,-80,-20];
var p_saint_sulpice = [2028*u,2957*u,20,0];
var p_saint_placide = [2028*u,3100*u,-110,5];
var p_montparnasse_bienvenue = [2005*u,3255*u,35,-20];
var p_valvin = [2158*u,3254*u,20,0];
var p_raspail = [2263*u,3315*u,20,0];
var p_denfert_rochereau = [2326*u,3392*u,20,0];
var p_mouton_duvernet = [2326*u,3531*u,10,20];
var p_alesia = [2257*u,3681*u,20,0];
var p_porte_d_orleans = [2198*u,3739*u,20,0];
var p_mairie_de_montrouge = [2198*u,3851*u,20,0];
var p_bobigny_pablo_picasso = [4024*u,1133*u,20,0];
var p_bobigny_pantin_raymond_queneau = [3909*u,1247*u,20,0];
var p_eglise_de_pantin = [3832*u,1324*u,20,0];
var p_hoche = [3722*u,1387*u,20,10];
var p_porte_de_pantin = [3563*u,1387*u,20,-10];
var p_ourcq = [3405*u,1387*u,20,-10];
var p_laumiere = [3283*u,1462*u,20,10];
var p_jacques_bonsergent = [2895*u,1921*u,20,0];
var p_oberkampf = [3061*u,2175*u,20,0];
var p_richard_lenoir = [3127*u,2427*u,15,0];
var p_breguet_sabin = [3033*u,2520*u,20,0];
var p_quai_de_la_rapee = [2938*u,2968*u,-140,0];
var p_gare_d_austerlitz = [2938*u,3173*u,20,0];
var p_saint_marcel = [2938*u,3294*u,20,0];
var p_campo_formio = [2869*u,3386*u,20,0];
var p_place_d_italie = [2779*u,3543*u,20,-10];
var p_kleber = [1038*u,2149*u,20,0];
var p_boissiere = [905*u,2281*u,20,0];
var p_passy = [909*u,2696*u,20,0];
var p_bir_hakeim = [1034*u,2819*u,20,0];
var p_dupleix = [1142*u,2926*u,20,0];
var p_la_motte_picquet_grenelle = [1293*u,3045*u,20,0];
var p_cambronne = [1500*u,3091*u,20,0];
var p_sevres_lecourbe = [1609*u,3214*u,20,0];
var p_pasteur = [1767*u,3278*u,20,20];
var p_edgar_quinet = [2075*u,3275*u,-50,30];
var p_saint_jacques = [2416*u,3483*u,20,0];
var p_glaciere = [2531*u,3541*u,20,-10];
var p_corvisart = [2663*u,3542*u,20,-10];
var p_nationale = [2922*u,3542*u,20,-10];
var p_chevaleret = [3062*u,3542*u,20,10];
var p_quai_de_la_gare = [3200*u,3481*u,20,0];
var p_bercy = [3351*u,3329*u,20,0];
var p_dugommier = [3442*u,3239*u,20,0];
var p_daumesnil = [3545*u,3136*u,20,0];
var p_bel_air = [3625*u,3054*u,20,0];
var p_picpus = [3707*u,2974*u,20,0];
var p_la_courneuve_8_mai_1945 = [3548*u,800*u,20,0];
var p_fort_d_aubervilliers = [3548*u,928*u,20,0];
var p_aubervilliers_pantin_quatre_chemins = [3439*u,1068*u,20,0];
var p_porte_de_la_villette = [3337*u,1170*u,20,0];
var p_corentin_cariou = [3255*u,1251*u,20,0];
var p_crimee = [3190*u,1316*u,20,0];
var p_riquet = [3124*u,1383*u,20,0];
var p_louis_blanc = [3058*u,1580*u,20,20];
var p_chateau_landon = [2981*u,1655*u,20,0];
var p_poissonniere = [2530*u,1717*u,20,-10];
var p_cadet = [2317*u,1750*u,10,-20];
var p_le_peletier = [2244*u,1824*u,20,0];
var p_chaussee_d_antin_la_fayette = [2058*u,2016*u,20,-5];
var p_pyramides = [1953*u,2280*u,20,0];
var p_pont_neuf = [2218*u,2486*u,20,20];
var p_pont_marie = [2617*u,2610*u,20,0];
var p_sully_morland = [2743*u,2763*u,-120,0];
var p_jussieu = [2685*u,3071*u,20,0];
var p_place_monge = [2596*u,3166*u,20,0];
var p_censier_daubenton = [2596*u,3288*u,20,0];
var p_les_gobelins = [2681*u,3401*u,20,0];
var p_tolbiac = [2756*u,3635*u,20,0];
var p_maison_blanche = [2756*u,3720*u,20,0];
var p_le_kremlin_bicetre = [2756*u,3830*u,20,0];
var p_villejuif_leo_lagrange = [2756*u,3923*u,20,0];
var p_villejuif_paul_vaillant_couturier = [2756*u,4017*u,20,0];
var p_villejuif_louis_aragon = [2756*u,4104*u,20,0];
var p_porte_d_italie = [2878*u,3796*u,10,-10];
var p_porte_de_choisy = [3023*u,3796*u,10,-10];
var p_porte_d_ivry = [3164*u,3796*u,10,-10];
var p_pierre_et_marie_curie = [3265*u,3843*u,20,0];
var p_mairie_d_ivry = [3333*u,3912*u,20,0];
var p_bolivar = [3287*u,1633*u,20,-5];
var p_buttes_chaumont = [3451*u,1663*u,-20,-20];
var p_botzaris = [3541*u,1663*u,20,5];
var p_place_des_fetes = [3669*u,1789*u,-40,30];
var p_pre_saint_gervais = [3785*u,1646*u,20,0];
var p_danube = [3669*u,1558*u,20,0];
var p_balard = [1040*u,3650*u,20,0];
var p_lourmel = [1157*u,3533*u,20,0];
var p_boucicaut = [1250*u,3442*u,20,0];
var p_felix_faure = [1292*u,3315*u,20,0];
var p_commerce = [1292*u,3194*u,20,0];
var p_ecole_militaire = [1292*u,2832*u,20,0];
var p_la_tour_maubourg = [1398*u,2685*u,-140,0];
var p_invalides = [1507*u,2578*u,20,0];
var p_madeleine = [1607*u,2256*u,15,25];
var p_richelieu_drouot = [2183*u,2038*u,5,25];
var p_grands_boulevards = [2343*u,2038*u,10,-20];
var p_bonne_nouvelle = [2560*u,2038*u,-20,-20];
var p_filles_du_calvaire = [2917*u,2292*u,20,0];
var p_saint_sebastien_froissart = [2917*u,2413*u,-210,0];
var p_chemin_vert = [2917*u,2529*u,-100,0];
var p_ledru_rollin = [3041*u,2748*u,20,0];
var p_faidherbe_chaligny = [3234*u,2826*u,20,0];
var p_montgallet = [3437*u,3030*u,20,0];
var p_michel_bizot = [3615*u,3207*u,20,0];
var p_porte_doree = [3680*u,3304*u,20,0];
var p_porte_de_charenton = [3589*u,3398*u,20,0];
var p_liberte = [3657*u,3512*u,20,0];
var p_charenton_ecoles = [3759*u,3613*u,20,0];
var p_ecole_veterinaire_de_maisons_alfort = [3858*u,3712*u,20,0];
var p_maisons_alfort_stade = [3932*u,3791*u,20,0];
var p_maisons_alfort_les_juilliottes = [3932*u,3871*u,20,0];
var p_creteil_l_echat = [3932*u,3953*u,20,0];
var p_creteil_universite = [3932*u,4027*u,20,0];
var p_creteil_prefecture = [3932*u,4106*u,20,0];
var p_pointe_du_lac = [3932*u,4183*u,20,0];
var p_pont_de_sevres = [462*u,3743*u,20,0];
var p_billancourt = [534*u,3671*u,20,0];
var p_marcel_sembat = [604*u,3601*u,20,0];
var p_porte_de_saint_cloud = [674*u,3510*u,20,0];
var p_exelmans = [674*u,3403*u,20,0];
var p_michel_ange_molitor = [674*u,3285*u,10,30];
var p_michel_ange_auteuil = [674*u,3173*u,-175,-10];
var p_jasmin = [674*u,3000*u,20,0];
var p_ranelagh = [674*u,2828*u,20,0];
var p_la_muette = [674*u,2654*u,20,0];
var p_rue_de_la_pompe = [707*u,2465*u,20,-10];
var p_trocadero = [895*u,2465*u,20,-10];
var p_iena = [1075*u,2465*u,20,20];
var p_alma_marceau = [1270*u,2386*u,20,0];
var p_saint_philippe_du_roule = [1553*u,2104*u,-160,-20];
var p_miromesnil = [1635*u,2022*u,-100,0];
var p_saint_augustin = [1706*u,1953*u,-120,0];
var p_havre_caumartin = [1867*u,2016*u,20,-10];
var p_saint_ambroise = [3260*u,2402*u,20,0];
var p_voltaire = [3339*u,2482*u,20,0];
var p_charonne = [3418*u,2559*u,20,0];
var p_rue_des_boulets = [3494*u,2637*u,-130,20];
var p_buzenval = [3729*u,2691*u,20,0];
var p_maraichers = [3790*u,2631*u,20,0];
var p_porte_de_montreuil = [3853*u,2566*u,20,0];
var p_robespierre = [3911*u,2510*u,20,0];
var p_croix_de_chavaux = [3975*u,2446*u,20,0];
var p_mairie_de_montreuil = [4035*u,2383*u,20,0];
var p_boulogne_pont_de_saint_cloud = [389*u,3397*u,20,0];
var p_boulogne_jean_jaures = [469*u,3317*u,20,20];
var p_chardon_lagache = [747*u,3286*u,30,5];
var p_mirabeau = [857*u,3248*u,20,0];
var p_javel_andre_citroen = [995*u,3170*u,20,20];
var p_charles_michels = [1121*u,3139*u,20,0];
var p_avenue_emile_zola = [1191*u,3068*u,-150,0];
var p_segur = [1566*u,3137*u,20,15];
var p_duroc = [1712*u,3100*u,20,0];
var p_vaneau = [1803*u,3009*u,20,0];
var p_sevres_babylone = [1896*u,2916*u,-150,0];
var p_mabillon = [2122*u,2861*u,20,20];
var p_cluny_la_sorbonne = [2376*u,2861*u,20,0];
var p_maubert_mutualite = [2479*u,2937*u,20,0];
var p_cardinal_lemoine = [2558*u,3015*u,20,0];
var p_porte_d_auteuil = [546*u,3239*u,-125,0];
var p_eglise_d_auteuil = [807*u,3170*u,20,-10];
var p_rambuteau = [2708*u,2358*u,20,0];
var p_goncourt = [3099*u,1967*u,20,0];
var p_pyrenees = [3355*u,1789*u,-20,30];
var p_jourdain = [3525*u,1789*u,-30,30];
var p_telegraphe = [3815*u,1789*u,-10,30];
var p_porte_des_lilas = [3910*u,1789*u,20,0];
var p_mairie_des_lilas = [4035*u,1651*u,20,0];
var p_front_populaire = [3001*u,1009*u,20,0];
var p_porte_de_la_chapelle = [2851*u,1074*u,20,10];
var p_marx_dormoy = [2851*u,1200*u,20,0];
var p_jules_joffrin = [2366*u,1242*u,20,-10];
var p_lamarck_caulaincourt = [2250*u,1260*u,20,20];
var p_abbesses = [2250*u,1354*u,20,0];
var p_saint_georges = [2250*u,1611*u,20,0];
var p_notre_dame_de_lorette = [2200*u,1767*u,-125,30];
var p_trinite_d_estienne_d_orves = [1983*u,1767*u,-100,-15];
var p_assemblee_nationale = [1603*u,2624*u,20,0];
var p_solferino = [1695*u,2718*u,20,0];
var p_rue_du_bac = [1801*u,2822*u,20,0];
var p_rennes = [1992*u,3014*u,-60,20];
var p_notre_dame_des_champs = [2088*u,3152*u,20,0];
var p_falguiere = [1812*u,3233*u,20,-10];
var p_volontaires = [1647*u,3397*u,20,0];
var p_vaugirard = [1540*u,3504*u,20,0];
var p_convention = [1495*u,3610*u,20,0];
var p_porte_de_versailles = [1351*u,3694*u,20,5];
var p_corentin_celton = [1174*u,3872*u,20,0];
var p_mairie_d_issy = [1051*u,3993*u,20,0];
var p_asnieres_gennevilliers_les_courtilles = [1174*u,538*u,20,0];
var p_les_agnettes = [1242*u,743*u,20,0];
var p_gabriel_peri = [1311*u,811*u,20,0];
var p_mairie_de_clichy = [1469*u,970*u,20,0];
var p_porte_de_clichy = [1628*u,1129*u,20,0];
var p_brochant = [1718*u,1219*u,-75,20];
var p_la_fourche = [1812*u,1339*u,20,0];
var p_liege = [1812*u,1608*u,20,0];
var p_varenne = [1506*u,2748*u,20,0];
var p_saint_francois_xavier = [1572*u,2958*u,20,0];
var p_gaite = [2005*u,3420*u,20,0];
var p_pernety = [1945*u,3520*u,20,0];
var p_plaisance = [1846*u,3619*u,20,0];
var p_porte_de_vanves = [1726*u,3739*u,20,0];
var p_malakoff_plateau_de_vanves = [1669*u,3851*u,20,0];
var p_malakoff_rue_etienne_dolet = [1669*u,3978*u,20,0];
var p_chatillon_montrouge = [1669*u,4104*u,20,0];
var p_saint_denis_universite = [2726*u,494*u,20,0];
var p_basilique_de_saint_denis = [2646*u,574*u,20,0];
var p_saint_denis_porte_de_paris = [2376*u,685*u,20,10];
var p_carrefour_pleyel = [2124*u,743*u,20,15];
var p_mairie_de_saint_ouen = [2019*u,848*u,20,0];
var p_garibaldi = [1912*u,956*u,20,0];
var p_porte_de_saint_ouen = [1812*u,1077*u,20,0];
var p_guy_moquet = [1812*u,1201*u,20,0];
var p_cour_saint_emilion = [3410*u,3473*u,20,0];
var p_bibliotheque_francois_mitterrand = [3325*u,3558*u,20,0];
var p_olympiades = [3113*u,3637*u,20,10];
...
var la_defense_m1 = new Station("la_defense/M1", la_defense, l1, p_la_defense);
var esplanade_de_la_defense_m1 = new Station("esplanade_de_la_defense/M1", esplanade_de_la_defense, l1, p_esplanade_de_la_defense);
var pont_de_neuilly_m1 = new Station("pont_de_neuilly/M1", pont_de_neuilly, l1, p_pont_de_neuilly);
var les_sablons_m1 = new Station("les_sablons/M1", les_sablons, l1, p_les_sablons);
var porte_maillot_m1 = new Station("porte_maillot/M1", porte_maillot, l1, p_porte_maillot);
var argentine_m1 = new Station("argentine/M1", argentine, l1, p_argentine);
var charles_de_gaulle_etoile_m1 = new Station("charles_de_gaulle_etoile/M1", charles_de_gaulle_etoile, l1, p_charles_de_gaulle_etoile);
var georges_v_m1 = new Station("georges_v/M1", georges_v, l1, p_georges_v);
var franklin_d_roosevelt_m1 = new Station("franklin_d_roosevelt/M1", franklin_d_roosevelt, l1, p_franklin_d_roosevelt);
var champs_elysees_clemenceau_m1 = new Station("champs_elysees_clemenceau/M1", champs_elysees_clemenceau, l1, p_champs_elysees_clemenceau);
var concorde_m1 = new Station("concorde/M1", concorde, l1, p_concorde);
var tuileries_m1 = new Station("tuileries/M1", tuileries, l1, p_tuileries);
var palais_royal_musee_du_louvre_m1 = new Station("palais_royal_musee_du_louvre/M1", palais_royal_musee_du_louvre, l1, p_palais_royal_musee_du_louvre);
var louvre_rivoli_m1 = new Station("louvre_rivoli/M1", louvre_rivoli, l1, p_louvre_rivoli);
var chatelet_m1 = new Station("chatelet/M1", chatelet, l1, p_chatelet);
var hotel_de_ville_m1 = new Station("hotel_de_ville/M1", hotel_de_ville, l1, p_hotel_de_ville);
var saint_paul_m1 = new Station("saint_paul/M1", saint_paul, l1, p_saint_paul);
var bastille_m1 = new Station("bastille/M1", bastille, l1, p_bastille);
var gare_de_lyon_m1 = new Station("gare_de_lyon/M1", gare_de_lyon, l1, p_gare_de_lyon);
var reuilly_diderot_m1 = new Station("reuilly_diderot/M1", reuilly_diderot, l1, p_reuilly_diderot);
var nation_m1 = new Station("nation/M1", nation, l1, p_nation);
var porte_de_vincennes_m1 = new Station("porte_de_vincennes/M1", porte_de_vincennes, l1, p_porte_de_vincennes);
var saint_mande_m1 = new Station("saint_mande/M1", saint_mande, l1, p_saint_mande);
var berault_m1 = new Station("berault/M1", berault, l1, p_berault);
var chateau_de_vincennes_m1 = new Station("chateau_de_vincennes/M1", chateau_de_vincennes, l1, p_chateau_de_vincennes);

var porte_dauphine_m2 = new Station("porte_dauphine/M2", porte_dauphine, l2, p_porte_dauphine);
var victor_hugo_m2 = new Station("victor_hugo/M2", victor_hugo, l2, p_victor_hugo);
var charles_de_gaulle_etoile_m2 = new Station("charles_de_gaulle_etoile/M2", charles_de_gaulle_etoile, l2, p_charles_de_gaulle_etoile);
var ternes_m2 = new Station("ternes/M2", ternes, l2, p_ternes);
var courcelles_m2 = new Station("courcelles/M2", courcelles, l2, p_courcelles);
var monceau_m2 = new Station("monceau/M2", monceau, l2, p_monceau);
var villiers_m2 = new Station("villiers/M2", villiers, l2, p_villiers);
var rome_m2 = new Station("rome/M2", rome, l2, p_rome);
var place_de_clichy_m2 = new Station("place_de_clichy/M2", place_de_clichy, l2, p_place_de_clichy);
var blanche_m2 = new Station("blanche/M2", blanche, l2, p_blanche);
var pigalle_m2 = new Station("pigalle/M2", pigalle, l2, p_pigalle);
var anvers_m2 = new Station("anvers/M2", anvers, l2, p_anvers);
var barbes_rochechouart_m2 = new Station("barbes_rochechouart/M2", barbes_rochechouart, l2, p_barbes_rochechouart);
var la_chapelle_m2 = new Station("la_chapelle/M2", la_chapelle, l2, p_la_chapelle);
var stalingrad_m2 = new Station("stalingrad/M2", stalingrad, l2, p_stalingrad);
var jaures_m2 = new Station("jaures/M2", jaures, l2, p_jaures);
var colonel_fabien_m2 = new Station("colonel_fabien/M2", colonel_fabien, l2, p_colonel_fabien);
var belleville_m2 = new Station("belleville/M2", belleville, l2, p_belleville);
var couronnes_m2 = new Station("couronnes/M2", couronnes, l2, p_couronnes);
var menilmontant_m2 = new Station("menilmontant/M2", menilmontant, l2, p_menilmontant);
var pere_lachaise_m2 = new Station("pere_lachaise/M2", pere_lachaise, l2, p_pere_lachaise);
var philippe_auguste_m2 = new Station("philippe_auguste/M2", philippe_auguste, l2, p_philippe_auguste);
var alexandre_dumas_m2 = new Station("alexandre_dumas/M2", alexandre_dumas, l2, p_alexandre_dumas);
var avron_m2 = new Station("avron/M2", avron, l2, p_avron);
var nation_m2 = new Station("nation/M2", nation, l2, p_nation);

var pont_de_levallois_becon_m3 = new Station("pont_de_levallois_becon/M3", pont_de_levallois_becon, l3, p_pont_de_levallois_becon);
var anatole_france_m3 = new Station("anatole_france/M3", anatole_france, l3, p_anatole_france);
var louise_michel_m3 = new Station("louise_michel/M3", louise_michel, l3, p_louise_michel);
var porte_de_champerret_m3 = new Station("porte_de_champerret/M3", porte_de_champerret, l3, p_porte_de_champerret);
var pereire_m3 = new Station("pereire/M3", pereire, l3, p_pereire);
var wagram_m3 = new Station("wagram/M3", wagram, l3, p_wagram);
var malesherbes_m3 = new Station("malesherbes/M3", malesherbes, l3, p_malesherbes);
var villiers_m3 = new Station("villiers/M3", villiers, l3, p_villiers);
var europe_m3 = new Station("europe/M3", europe, l3, p_europe);
var saint_lazare_m3 = new Station("saint_lazare/M3", saint_lazare, l3, p_saint_lazare);
var havre_caumartin_m3 = new Station("havre_caumartin/M3", havre_caumartin, l3, p_havre_caumartin);
var opera_m3 = new Station("opera/M3", opera, l3, p_opera);
var quatre_septembre_m3 = new Station("quatre_septembre/M3", quatre_septembre, l3, p_quatre_septembre);
var bourse_m3 = new Station("bourse/M3", bourse, l3, p_bourse);
var sentier_m3 = new Station("sentier/M3", sentier, l3, p_sentier);
var reaumur_sebastopol_m3 = new Station("reaumur_sebastopol/M3", reaumur_sebastopol, l3, p_reaumur_sebastopol);
var arts_et_metiers_m3 = new Station("arts_et_metiers/M3", arts_et_metiers, l3, p_arts_et_metiers);
var temple_m3 = new Station("temple/M3", temple, l3, p_temple);
var republique_m3 = new Station("republique/M3", republique, l3, p_republique);
var parmentier_m3 = new Station("parmentier/M3", parmentier, l3, p_parmentier);
var rue_saint_maur_m3 = new Station("rue_saint_maur/M3", rue_saint_maur, l3, p_rue_saint_maur);
var pere_lachaise_m3 = new Station("pere_lachaise/M3", pere_lachaise, l3, p_pere_lachaise);
var gambetta_m3 = new Station("gambetta/M3", gambetta, l3, p_gambetta);
var porte_de_bagnolet_m3 = new Station("porte_de_bagnolet/M3", porte_de_bagnolet, l3, p_porte_de_bagnolet);
var gallieni_m3 = new Station("gallieni/M3", gallieni, l3, p_gallieni);

var gambetta_m3b = new Station("gambetta/M3bis", gambetta, l3bis, p_gambetta);
var pelleport_m3b = new Station("pelleport/M3bis", pelleport, l3bis, p_pelleport);
var saint_fargeau_m3b = new Station("saint_fargeau/M3bis", saint_fargeau, l3bis, p_saint_fargeau);
var porte_des_lilas_m3b = new Station("porte_des_lilas/M3bis", porte_des_lilas, l3bis, p_porte_des_lilas);

var porte_de_clignancourt_m4 = new Station("porte_de_clignancourt/M4", porte_de_clignancourt, l4, p_porte_de_clignancourt);
var simplon_m4 = new Station("simplon/M4", simplon, l4, p_simplon);
var marcadet_poissonniers_m4 = new Station("marcadet_poissonniers/M4", marcadet_poissonniers, l4, p_marcadet_poissonniers);
var chateau_rouge_m4 = new Station("chateau_rouge/M4", chateau_rouge, l4, p_chateau_rouge);
var barbes_rochechouart_m4 = new Station("barbes_rochechouart/M4", barbes_rochechouart, l4, p_barbes_rochechouart);
var gare_du_nord_m4 = new Station("gare_du_nord/M4", gare_du_nord, l4, p_gare_du_nord);
var gare_de_l_est_m4 = new Station("gare_de_l_est/M4", gare_de_l_est, l4, p_gare_de_l_est);
var chateau_d_eau_m4 = new Station("chateau_d_eau/M4", chateau_d_eau, l4, p_chateau_d_eau);
var strasbourg_saint_denis_m4 = new Station("strasbourg_saint_denis/M4", strasbourg_saint_denis, l4, p_strasbourg_saint_denis);
var reaumur_sebastopol_m4 = new Station("reaumur_sebastopol/M4", reaumur_sebastopol, l4, p_reaumur_sebastopol);
var etienne_marcel_m4 = new Station("etienne_marcel/M4", etienne_marcel, l4, p_etienne_marcel);
var les_halles_m4 = new Station("les_halles/M4", les_halles, l4, p_les_halles);
var chatelet_m4 = new Station("chatelet/M4", chatelet, l4, p_chatelet);
var cite_m4 = new Station("cite/M4", cite, l4, p_cite);
var saint_michel_m4 = new Station("saint_michel/M4", saint_michel, l4, p_saint_michel);
var odeon_m4 = new Station("odeon/M4", odeon, l4, p_odeon);
var saint_germain_des_pres_m4 = new Station("saint_germain_des_pres/M4", saint_germain_des_pres, l4, p_saint_germain_des_pres);
var saint_sulpice_m4 = new Station("saint_sulpice/M4", saint_sulpice, l4, p_saint_sulpice);
var saint_placide_m4 = new Station("saint_placide/M4", saint_placide, l4, p_saint_placide);
var montparnasse_bienvenue_m4 = new Station("montparnasse_bienvenue/M4", montparnasse_bienvenue, l4, p_montparnasse_bienvenue);
var valvin_m4 = new Station("valvin/M4", valvin, l4, p_valvin);
var raspail_m4 = new Station("raspail/M4", raspail, l4, p_raspail);
var denfert_rochereau_m4 = new Station("denfert_rochereau/M4", denfert_rochereau, l4, p_denfert_rochereau);
var mouton_duvernet_m4 = new Station("mouton_duvernet/M4", mouton_duvernet, l4, p_mouton_duvernet);
var alesia_m4 = new Station("alesia/M4", alesia, l4, p_alesia);
var porte_d_orleans_m4 = new Station("porte_d_orleans/M4", porte_d_orleans, l4, p_porte_d_orleans);
var mairie_de_montrouge_m4 = new Station("mairie_de_montrouge/M4", mairie_de_montrouge, l4, p_mairie_de_montrouge);

var bobigny_pablo_picasso_m5 = new Station("bobigny_pablo_picasso/M5", bobigny_pablo_picasso, l5, p_bobigny_pablo_picasso);
var bobigny_pantin_raymond_queneau_m5 = new Station("bobigny_pantin_raymond_queneau/M5", bobigny_pantin_raymond_queneau, l5, p_bobigny_pantin_raymond_queneau);
var eglise_de_pantin_m5 = new Station("eglise_de_pantin/M5", eglise_de_pantin, l5, p_eglise_de_pantin);
var hoche_m5 = new Station("hoche/M5", hoche, l5, p_hoche);
var porte_de_pantin_m5 = new Station("porte_de_pantin/M5", porte_de_pantin, l5, p_porte_de_pantin);
var ourcq_m5 = new Station("ourcq/M5", ourcq, l5, p_ourcq);
var laumiere_m5 = new Station("laumiere/M5", laumiere, l5, p_laumiere);
var jaures_m5 = new Station("jaures/M5", jaures, l5, p_jaures);
var stalingrad_m5 = new Station("stalingrad/M5", stalingrad, l5, p_stalingrad);
var gare_du_nord_m5 = new Station("gare_du_nord/M5", gare_du_nord, l5, p_gare_du_nord);
var gare_de_l_est_m5 = new Station("gare_de_l_est/M5", gare_de_l_est, l5, p_gare_de_l_est);
var jacques_bonsergent_m5 = new Station("jacques_bonsergent/M5", jacques_bonsergent, l5, p_jacques_bonsergent);
var republique_m5 = new Station("republique/M5", republique, l5, p_republique);
var oberkampf_m5 = new Station("oberkampf/M5", oberkampf, l5, p_oberkampf);
var richard_lenoir_m5 = new Station("richard_lenoir/M5", richard_lenoir, l5, p_richard_lenoir);
var breguet_sabin_m5 = new Station("breguet_sabin/M5", breguet_sabin, l5, p_breguet_sabin);
var bastille_m5 = new Station("bastille/M5", bastille, l5, p_bastille);
var quai_de_la_rapee_m5 = new Station("quai_de_la_rapee/M5", quai_de_la_rapee, l5, p_quai_de_la_rapee);
var gare_d_austerlitz_m5 = new Station("gare_d_austerlitz/M5", gare_d_austerlitz, l5, p_gare_d_austerlitz);
var saint_marcel_m5 = new Station("saint_marcel/M5", saint_marcel, l5, p_saint_marcel);
var campo_formio_m5 = new Station("campo_formio/M5", campo_formio, l5, p_campo_formio);
var place_d_italie_m5 = new Station("place_d_italie/M5", place_d_italie, l5, p_place_d_italie);

var charles_de_gaulle_etoile_m6 = new Station("charles_de_gaulle_etoile/M6", charles_de_gaulle_etoile, l6, p_charles_de_gaulle_etoile);
var kleber_m6 = new Station("kleber/M6", kleber, l6, p_kleber);
var boissiere_m6 = new Station("boissiere/M6", boissiere, l6, p_boissiere);
var trocadero_m6 = new Station("trocadero/M6", trocadero, l6, p_trocadero);
var passy_m6 = new Station("passy/M6", passy, l6, p_passy);
var bir_hakeim_m6 = new Station("bir_hakeim/M6", bir_hakeim, l6, p_bir_hakeim);
var dupleix_m6 = new Station("dupleix/M6", dupleix, l6, p_dupleix);
var la_motte_picquet_grenelle_m6 = new Station("la_motte_picquet_grenelle/M6", la_motte_picquet_grenelle, l6, p_la_motte_picquet_grenelle);
var cambronne_m6 = new Station("cambronne/M6", cambronne, l6, p_cambronne);
var sevres_lecourbe_m6 = new Station("sevres_lecourbe/M6", sevres_lecourbe, l6, p_sevres_lecourbe);
var pasteur_m6 = new Station("pasteur/M6", pasteur, l6, p_pasteur);
var montparnasse_bienvenue_m6 = new Station("montparnasse_bienvenue/M6", montparnasse_bienvenue, l6, p_montparnasse_bienvenue);
var edgar_quinet_m6 = new Station("edgar_quinet/M6", edgar_quinet, l6, p_edgar_quinet);
var raspail_m6 = new Station("raspail/M6", raspail, l6, p_raspail);
var denfert_rochereau_m6 = new Station("denfert_rochereau/M6", denfert_rochereau, l6, p_denfert_rochereau);
var saint_jacques_m6 = new Station("saint_jacques/M6", saint_jacques, l6, p_saint_jacques);
var glaciere_m6 = new Station("glaciere/M6", glaciere, l6, p_glaciere);
var corvisart_m6 = new Station("corvisart/M6", corvisart, l6, p_corvisart);
var place_d_italie_m6 = new Station("place_d_italie/M6", place_d_italie, l6, p_place_d_italie);
var nationale_m6 = new Station("nationale/M6", nationale, l6, p_nationale);
var chevaleret_m6 = new Station("chevaleret/M6", chevaleret, l6, p_chevaleret);
var quai_de_la_gare_m6 = new Station("quai_de_la_gare/M6", quai_de_la_gare, l6, p_quai_de_la_gare);
var bercy_m6 = new Station("bercy/M6", bercy, l6, p_bercy);
var dugommier_m6 = new Station("dugommier/M6", dugommier, l6, p_dugommier);
var daumesnil_m6 = new Station("daumesnil/M6", daumesnil, l6, p_daumesnil);
var bel_air_m6 = new Station("bel_air/M6", bel_air, l6, p_bel_air);
var picpus_m6 = new Station("picpus/M6", picpus, l6, p_picpus);
var nation_m6 = new Station("nation/M6", nation, l6, p_nation);

var la_courneuve_8_mai_1945_m7a = new Station("la_courneuve_8_mai_1945/M7A", la_courneuve_8_mai_1945, l7, p_la_courneuve_8_mai_1945);
var fort_d_aubervilliers_m7a = new Station("fort_d_aubervilliers/M7A", fort_d_aubervilliers, l7, p_fort_d_aubervilliers);
var aubervilliers_pantin_quatre_chemins_m7a = new Station("aubervilliers_pantin_quatre_chemins/M7A", aubervilliers_pantin_quatre_chemins, l7, p_aubervilliers_pantin_quatre_chemins);
var porte_de_la_villette_m7a = new Station("porte_de_la_villette/M7A", porte_de_la_villette, l7, p_porte_de_la_villette);
var corentin_cariou_m7a = new Station("corentin_cariou/M7A", corentin_cariou, l7, p_corentin_cariou);
var crimee_m7a = new Station("crimee/M7A", crimee, l7, p_crimee);
var riquet_m7a = new Station("riquet/M7A", riquet, l7, p_riquet);
var stalingrad_m7a = new Station("stalingrad/M7A", stalingrad, l7, p_stalingrad);
var louis_blanc_m7a = new Station("louis_blanc/M7A", louis_blanc, l7, p_louis_blanc);
var chateau_landon_m7a = new Station("chateau_landon/M7A", chateau_landon, l7, p_chateau_landon);
var gare_de_l_est_m7a = new Station("gare_de_l_est/M7A", gare_de_l_est, l7, p_gare_de_l_est);
var poissonniere_m7a = new Station("poissonniere/M7A", poissonniere, l7, p_poissonniere);
var cadet_m7a = new Station("cadet/M7A", cadet, l7, p_cadet);
var le_peletier_m7a = new Station("le_peletier/M7A", le_peletier, l7, p_le_peletier);
var chaussee_d_antin_la_fayette_m7a = new Station("chaussee_d_antin_la_fayette/M7A", chaussee_d_antin_la_fayette, l7, p_chaussee_d_antin_la_fayette);
var opera_m7a = new Station("opera/M7A", opera, l7, p_opera);
var pyramides_m7a = new Station("pyramides/M7A", pyramides, l7, p_pyramides);
var palais_royal_musee_du_louvre_m7a = new Station("palais_royal_musee_du_louvre/M7A", palais_royal_musee_du_louvre, l7, p_palais_royal_musee_du_louvre);
var pont_neuf_m7a = new Station("pont_neuf/M7A", pont_neuf, l7, p_pont_neuf);
var chatelet_m7a = new Station("chatelet/M7A", chatelet, l7, p_chatelet);
var pont_marie_m7a = new Station("pont_marie/M7A", pont_marie, l7, p_pont_marie);
var sully_morland_m7a = new Station("sully_morland/M7A", sully_morland, l7, p_sully_morland);
var jussieu_m7a = new Station("jussieu/M7A", jussieu, l7, p_jussieu);
var place_monge_m7a = new Station("place_monge/M7A", place_monge, l7, p_place_monge);
var censier_daubenton_m7a = new Station("censier_daubenton/M7A", censier_daubenton, l7, p_censier_daubenton);
var les_gobelins_m7a = new Station("les_gobelins/M7A", les_gobelins, l7, p_les_gobelins);
var place_d_italie_m7a = new Station("place_d_italie/M7A", place_d_italie, l7, p_place_d_italie);
var tolbiac_m7a = new Station("tolbiac/M7A", tolbiac, l7, p_tolbiac);
var maison_blanche_m7a = new Station("maison_blanche/M7A", maison_blanche, l7, p_maison_blanche);
var le_kremlin_bicetre_m7a = new Station("le_kremlin_bicetre/M7A", le_kremlin_bicetre, l7, p_le_kremlin_bicetre);
var villejuif_leo_lagrange_m7a = new Station("villejuif_leo_lagrange/M7A", villejuif_leo_lagrange, l7, p_villejuif_leo_lagrange);
var villejuif_paul_vaillant_couturier_m7a = new Station("villejuif_paul_vaillant_couturier/M7A", villejuif_paul_vaillant_couturier, l7, p_villejuif_paul_vaillant_couturier);
var villejuif_louis_aragon_m7a = new Station("villejuif_louis_aragon/M7A", villejuif_louis_aragon, l7, p_villejuif_louis_aragon);

var la_courneuve_8_mai_1945_m7b = new Station("la_courneuve_8_mai_1945/M7B", la_courneuve_8_mai_1945, l7, p_la_courneuve_8_mai_1945);
var fort_d_aubervilliers_m7b = new Station("fort_d_aubervilliers/M7B", fort_d_aubervilliers, l7, p_fort_d_aubervilliers);
var aubervilliers_pantin_quatre_chemins_m7b = new Station("aubervilliers_pantin_quatre_chemins/M7B", aubervilliers_pantin_quatre_chemins, l7, p_aubervilliers_pantin_quatre_chemins);
var porte_de_la_villette_m7b = new Station("porte_de_la_villette/M7B", porte_de_la_villette, l7, p_porte_de_la_villette);
var corentin_cariou_m7b = new Station("corentin_cariou/M7B", corentin_cariou, l7, p_corentin_cariou);
var crimee_m7b = new Station("crimee/M7B", crimee, l7, p_crimee);
var riquet_m7b = new Station("riquet/M7B", riquet, l7, p_riquet);
var stalingrad_m7b = new Station("stalingrad/M7B", stalingrad, l7, p_stalingrad);
var louis_blanc_m7b = new Station("louis_blanc/M7B", louis_blanc, l7, p_louis_blanc);
var chateau_landon_m7b = new Station("chateau_landon/M7B", chateau_landon, l7, p_chateau_landon);
var gare_de_l_est_m7b = new Station("gare_de_l_est/M7B", gare_de_l_est, l7, p_gare_de_l_est);
var poissonniere_m7b = new Station("poissonniere/M7B", poissonniere, l7, p_poissonniere);
var cadet_m7b = new Station("cadet/M7B", cadet, l7, p_cadet);
var le_peletier_m7b = new Station("le_peletier/M7B", le_peletier, l7, p_le_peletier);
var chaussee_d_antin_la_fayette_m7b = new Station("chaussee_d_antin_la_fayette/M7B", chaussee_d_antin_la_fayette, l7, p_chaussee_d_antin_la_fayette);
var opera_m7b = new Station("opera/M7B", opera, l7, p_opera);
var pyramides_m7b = new Station("pyramides/M7B", pyramides, l7, p_pyramides);
var palais_royal_musee_du_louvre_m7b = new Station("palais_royal_musee_du_louvre/M7B", palais_royal_musee_du_louvre, l7, p_palais_royal_musee_du_louvre);
var pont_neuf_m7b = new Station("pont_neuf/M7B", pont_neuf, l7, p_pont_neuf);
var chatelet_m7b = new Station("chatelet/M7B", chatelet, l7, p_chatelet);
var pont_marie_m7b = new Station("pont_marie/M7B", pont_marie, l7, p_pont_marie);
var sully_morland_m7b = new Station("sully_morland/M7B", sully_morland, l7, p_sully_morland);
var jussieu_m7b = new Station("jussieu/M7B", jussieu, l7, p_jussieu);
var place_monge_m7b = new Station("place_monge/M7B", place_monge, l7, p_place_monge);
var censier_daubenton_m7b = new Station("censier_daubenton/M7B", censier_daubenton, l7, p_censier_daubenton);
var les_gobelins_m7b = new Station("les_gobelins/M7B", les_gobelins, l7, p_les_gobelins);
var place_d_italie_m7b = new Station("place_d_italie/M7B", place_d_italie, l7, p_place_d_italie);
var tolbiac_m7b = new Station("tolbiac/M7B", tolbiac, l7, p_tolbiac);
var maison_blanche_m7b = new Station("maison_blanche/M7B", maison_blanche, l7, p_maison_blanche);
var porte_d_italie_m7b = new Station("porte_d_italie/M7B", porte_d_italie, l7, p_porte_d_italie);
var porte_de_choisy_m7b = new Station("porte_de_choisy/M7B", porte_de_choisy, l7, p_porte_de_choisy);
var porte_d_ivry_m7b = new Station("porte_d_ivry/M7B", porte_d_ivry, l7, p_porte_d_ivry);
var pierre_et_marie_curie_m7b = new Station("pierre_et_marie_curie/M7B", pierre_et_marie_curie, l7, p_pierre_et_marie_curie);
var mairie_d_ivry_m7b = new Station("mairie_d_ivry/M7B", mairie_d_ivry, l7, p_mairie_d_ivry);

var louis_blanc_m7bisa = new Station("louis_blanc/M7bisA", louis_blanc, l7bis, p_louis_blanc);
var jaures_m7bisa = new Station("jaures/M7bisA", jaures, l7bis, p_jaures);
var bolivar_m7bisa = new Station("bolivar/M7bisA", bolivar, l7bis, p_bolivar);
var buttes_chaumont_m7bisa = new Station("buttes_chaumont/M7bisA", buttes_chaumont, l7bis, p_buttes_chaumont);
var botzaris_m7bisa = new Station("botzaris/M7bisA", botzaris, l7bis, p_botzaris);
var place_des_fetes_m7bisa = new Station("place_des_fetes/M7bisA", place_des_fetes, l7bis, p_place_des_fetes);
var pre_saint_gervais_m7bisa = new Station("pre_saint_gervais/M7bisA", pre_saint_gervais, l7bis, p_pre_saint_gervais);

var louis_blanc_m7bisb = new Station("louis_blanc/M7bisB", louis_blanc, l7bis, p_louis_blanc);
var jaures_m7bisb = new Station("jaures/M7bisB", jaures, l7bis, p_jaures);
var bolivar_m7bisb = new Station("bolivar/M7bisB", bolivar, l7bis, p_bolivar);
var buttes_chaumont_m7bisb = new Station("buttes_chaumont/M7bisB", buttes_chaumont, l7bis, p_buttes_chaumont);
var botzaris_m7bisb = new Station("botzaris/M7bisB", botzaris, l7bis, p_botzaris);
var danube_m7bisb = new Station("danube/M7bisB", danube, l7bis, p_danube);
var pre_saint_gervais_m7bisb = new Station("pre_saint_gervais/M7bisB", pre_saint_gervais, l7bis, p_pre_saint_gervais);

var balard_m8 = new Station("balard/M8", balard, l8, p_balard);
var lourmel_m8 = new Station("lourmel/M8", lourmel, l8, p_lourmel);
var boucicaut_m8 = new Station("boucicaut/M8", boucicaut, l8, p_boucicaut);
var felix_faure_m8 = new Station("felix_faure/M8", felix_faure, l8, p_felix_faure);
var commerce_m8 = new Station("commerce/M8", commerce, l8, p_commerce);
var la_motte_picquet_grenelle_m8 = new Station("la_motte_picquet_grenelle/M8", la_motte_picquet_grenelle, l8, p_la_motte_picquet_grenelle);
var ecole_militaire_m8 = new Station("ecole_militaire/M8", ecole_militaire, l8, p_ecole_militaire);
var la_tour_maubourg_m8 = new Station("la_tour_maubourg/M8", la_tour_maubourg, l8, p_la_tour_maubourg);
var invalides_m8 = new Station("invalides/M8", invalides, l8, p_invalides);
var concorde_m8 = new Station("concorde/M8", concorde, l8, p_concorde);
var madeleine_m8 = new Station("madeleine/M8", madeleine, l8, p_madeleine);
var opera_m8 = new Station("opera/M8", opera, l8, p_opera);
var richelieu_drouot_m8 = new Station("richelieu_drouot/M8", richelieu_drouot, l8, p_richelieu_drouot);
var grands_boulevards_m8 = new Station("grands_boulevards/M8", grands_boulevards, l8, p_grands_boulevards);
var bonne_nouvelle_m8 = new Station("bonne_nouvelle/M8", bonne_nouvelle, l8, p_bonne_nouvelle);
var strasbourg_saint_denis_m8 = new Station("strasbourg_saint_denis/M8", strasbourg_saint_denis, l8, p_strasbourg_saint_denis);
var republique_m8 = new Station("republique/M8", republique, l8, p_republique);
var filles_du_calvaire_m8 = new Station("filles_du_calvaire/M8", filles_du_calvaire, l8, p_filles_du_calvaire);
var saint_sebastien_froissart_m8 = new Station("saint_sebastien_froissart/M8", saint_sebastien_froissart, l8, p_saint_sebastien_froissart);
var chemin_vert_m8 = new Station("chemin_vert/M8", chemin_vert, l8, p_chemin_vert);
var bastille_m8 = new Station("bastille/M8", bastille, l8, p_bastille);
var ledru_rollin_m8 = new Station("ledru_rollin/M8", ledru_rollin, l8, p_ledru_rollin);
var faidherbe_chaligny_m8 = new Station("faidherbe_chaligny/M8", faidherbe_chaligny, l8, p_faidherbe_chaligny);
var reuilly_diderot_m8 = new Station("reuilly_diderot/M8", reuilly_diderot, l8, p_reuilly_diderot);
var montgallet_m8 = new Station("montgallet/M8", montgallet, l8, p_montgallet);
var daumesnil_m8 = new Station("daumesnil/M8", daumesnil, l8, p_daumesnil);
var michel_bizot_m8 = new Station("michel_bizot/M8", michel_bizot, l8, p_michel_bizot);
var porte_doree_m8 = new Station("porte_doree/M8", porte_doree, l8, p_porte_doree);
var porte_de_charenton_m8 = new Station("porte_de_charenton/M8", porte_de_charenton, l8, p_porte_de_charenton);
var liberte_m8 = new Station("liberte/M8", liberte, l8, p_liberte);
var charenton_ecoles_m8 = new Station("charenton_ecoles/M8", charenton_ecoles, l8, p_charenton_ecoles);
var ecole_veterinaire_de_maisons_alfort_m8 = new Station("ecole_veterinaire_de_maisons_alfort/M8", ecole_veterinaire_de_maisons_alfort, l8, p_ecole_veterinaire_de_maisons_alfort);
var maisons_alfort_stade_m8 = new Station("maisons_alfort_stade/M8", maisons_alfort_stade, l8, p_maisons_alfort_stade);
var maisons_alfort_les_juilliottes_m8 = new Station("maisons_alfort_les_juilliottes/M8", maisons_alfort_les_juilliottes, l8, p_maisons_alfort_les_juilliottes);
var creteil_l_echat_m8 = new Station("creteil_l_echat/M8", creteil_l_echat, l8, p_creteil_l_echat);
var creteil_universite_m8 = new Station("creteil_universite/M8", creteil_universite, l8, p_creteil_universite);
var creteil_prefecture_m8 = new Station("creteil_prefecture/M8", creteil_prefecture, l8, p_creteil_prefecture);
var pointe_du_lac_m8 = new Station("pointe_du_lac/M8", pointe_du_lac, l8, p_pointe_du_lac);

var pont_de_sevres_m9 = new Station("pont_de_sevres/M9", pont_de_sevres, l9, p_pont_de_sevres);
var billancourt_m9 = new Station("billancourt/M9", billancourt, l9, p_billancourt);
var marcel_sembat_m9 = new Station("marcel_sembat/M9", marcel_sembat, l9, p_marcel_sembat);
var porte_de_saint_cloud_m9 = new Station("porte_de_saint_cloud/M9", porte_de_saint_cloud, l9, p_porte_de_saint_cloud);
var exelmans_m9 = new Station("exelmans/M9", exelmans, l9, p_exelmans);
var michel_ange_molitor_m9 = new Station("michel_ange_molitor/M9", michel_ange_molitor, l9, p_michel_ange_molitor);
var michel_ange_auteuil_m9 = new Station("michel_ange_auteuil/M9", michel_ange_auteuil, l9, p_michel_ange_auteuil);
var jasmin_m9 = new Station("jasmin/M9", jasmin, l9, p_jasmin);
var ranelagh_m9 = new Station("ranelagh/M9", ranelagh, l9, p_ranelagh);
var la_muette_m9 = new Station("la_muette/M9", la_muette, l9, p_la_muette);
var rue_de_la_pompe_m9 = new Station("rue_de_la_pompe/M9", rue_de_la_pompe, l9, p_rue_de_la_pompe);
var trocadero_m9 = new Station("trocadero/M9", trocadero, l9, p_trocadero);
var iena_m9 = new Station("iena/M9", iena, l9, p_iena);
var alma_marceau_m9 = new Station("alma_marceau/M9", alma_marceau, l9, p_alma_marceau);
var franklin_d_roosevelt_m9 = new Station("franklin_d_roosevelt/M9", franklin_d_roosevelt, l9, p_franklin_d_roosevelt);
var saint_philippe_du_roule_m9 = new Station("saint_philippe_du_roule/M9", saint_philippe_du_roule, l9, p_saint_philippe_du_roule);
var miromesnil_m9 = new Station("miromesnil/M9", miromesnil, l9, p_miromesnil);
var saint_augustin_m9 = new Station("saint_augustin/M9", saint_augustin, l9, p_saint_augustin);
var havre_caumartin_m9 = new Station("havre_caumartin/M9", havre_caumartin, l9, p_havre_caumartin);
var chaussee_d_antin_la_fayette_m9 = new Station("chaussee_d_antin_la_fayette/M9", chaussee_d_antin_la_fayette, l9, p_chaussee_d_antin_la_fayette);
var richelieu_drouot_m9 = new Station("richelieu_drouot/M9", richelieu_drouot, l9, p_richelieu_drouot);
var grands_boulevards_m9 = new Station("grands_boulevards/M9", grands_boulevards, l9, p_grands_boulevards);
var bonne_nouvelle_m9 = new Station("bonne_nouvelle/M9", bonne_nouvelle, l9, p_bonne_nouvelle);
var strasbourg_saint_denis_m9 = new Station("strasbourg_saint_denis/M9", strasbourg_saint_denis, l9, p_strasbourg_saint_denis);
var republique_m9 = new Station("republique/M9", republique, l9, p_republique);
var oberkampf_m9 = new Station("oberkampf/M9", oberkampf, l9, p_oberkampf);
var saint_ambroise_m9 = new Station("saint_ambroise/M9", saint_ambroise, l9, p_saint_ambroise);
var voltaire_m9 = new Station("voltaire/M9", voltaire, l9, p_voltaire);
var charonne_m9 = new Station("charonne/M9", charonne, l9, p_charonne);
var rue_des_boulets_m9 = new Station("rue_des_boulets/M9", rue_des_boulets, l9, p_rue_des_boulets);
var nation_m9 = new Station("nation/M9", nation, l9, p_nation);
var buzenval_m9 = new Station("buzenval/M9", buzenval, l9, p_buzenval);
var maraichers_m9 = new Station("maraichers/M9", maraichers, l9, p_maraichers);
var porte_de_montreuil_m9 = new Station("porte_de_montreuil/M9", porte_de_montreuil, l9, p_porte_de_montreuil);
var robespierre_m9 = new Station("robespierre/M9", robespierre, l9, p_robespierre);
var croix_de_chavaux_m9 = new Station("croix_de_chavaux/M9", croix_de_chavaux, l9, p_croix_de_chavaux);
var mairie_de_montreuil_m9 = new Station("mairie_de_montreuil/M9", mairie_de_montreuil, l9, p_mairie_de_montreuil);

var boulogne_pont_de_saint_cloud_m10a = new Station("boulogne_pont_de_saint_cloud/M10A", boulogne_pont_de_saint_cloud, l10, p_boulogne_pont_de_saint_cloud);
var boulogne_jean_jaures_m10a = new Station("boulogne_jean_jaures/M10A", boulogne_jean_jaures, l10, p_boulogne_jean_jaures);
var michel_ange_molitor_m10a = new Station("michel_ange_molitor/M10A", michel_ange_molitor, l10, p_michel_ange_molitor);
var chardon_lagache_m10a = new Station("chardon_lagache/M10A", chardon_lagache, l10, p_chardon_lagache);
var mirabeau_m10a = new Station("mirabeau/M10A", mirabeau, l10, p_mirabeau);
var javel_andre_citroen_m10a = new Station("javel_andre_citroen/M10A", javel_andre_citroen, l10, p_javel_andre_citroen);
var charles_michels_m10a = new Station("charles_michels/M10A", charles_michels, l10, p_charles_michels);
var avenue_emile_zola_m10a = new Station("avenue_emile_zola/M10A", avenue_emile_zola, l10, p_avenue_emile_zola);
var la_motte_picquet_grenelle_m10a = new Station("la_motte_picquet_grenelle/M10A", la_motte_picquet_grenelle, l10, p_la_motte_picquet_grenelle);
var segur_m10a = new Station("segur/M10A", segur, l10, p_segur);
var duroc_m10a = new Station("duroc/M10A", duroc, l10, p_duroc);
var vaneau_m10a = new Station("vaneau/M10A", vaneau, l10, p_vaneau);
var sevres_babylone_m10a = new Station("sevres_babylone/M10A", sevres_babylone, l10, p_sevres_babylone);
var mabillon_m10a = new Station("mabillon/M10A", mabillon, l10, p_mabillon);
var odeon_m10a = new Station("odeon/M10A", odeon, l10, p_odeon);
var cluny_la_sorbonne_m10a = new Station("cluny_la_sorbonne/M10A", cluny_la_sorbonne, l10, p_cluny_la_sorbonne);
var maubert_mutualite_m10a = new Station("maubert_mutualite/M10A", maubert_mutualite, l10, p_maubert_mutualite);
var cardinal_lemoine_m10a = new Station("cardinal_lemoine/M10A", cardinal_lemoine, l10, p_cardinal_lemoine);
var jussieu_m10a = new Station("jussieu/M10A", jussieu, l10, p_jussieu);
var gare_d_austerlitz_m10a = new Station("gare_d_austerlitz/M10A", gare_d_austerlitz, l10, p_gare_d_austerlitz);

var boulogne_pont_de_saint_cloud_m10b = new Station("boulogne_pont_de_saint_cloud/M10B", boulogne_pont_de_saint_cloud, l10, p_boulogne_pont_de_saint_cloud);
var boulogne_jean_jaures_m10b = new Station("boulogne_jean_jaures/M10B", boulogne_jean_jaures, l10, p_boulogne_jean_jaures);
var porte_d_auteuil_m10b = new Station("porte_d_auteuil/M10B", porte_d_auteuil, l10, p_porte_d_auteuil);
var michel_ange_auteuil_m10b = new Station("michel_ange_auteuil/M10B", michel_ange_auteuil, l10, p_michel_ange_auteuil);
var eglise_d_auteuil_m10b = new Station("eglise_d_auteuil/M10B", eglise_d_auteuil, l10, p_eglise_d_auteuil);
var javel_andre_citroen_m10b = new Station("javel_andre_citroen/M10B", javel_andre_citroen, l10, p_javel_andre_citroen);
var charles_michels_m10b = new Station("charles_michels/M10B", charles_michels, l10, p_charles_michels);
var avenue_emile_zola_m10b = new Station("avenue_emile_zola/M10B", avenue_emile_zola, l10, p_avenue_emile_zola);
var la_motte_picquet_grenelle_m10b = new Station("la_motte_picquet_grenelle/M10B", la_motte_picquet_grenelle, l10, p_la_motte_picquet_grenelle);
var segur_m10b = new Station("segur/M10B", segur, l10, p_segur);
var duroc_m10b = new Station("duroc/M10B", duroc, l10, p_duroc);
var vaneau_m10b = new Station("vaneau/M10B", vaneau, l10, p_vaneau);
var sevres_babylone_m10b = new Station("sevres_babylone/M10B", sevres_babylone, l10, p_sevres_babylone);
var mabillon_m10b = new Station("mabillon/M10B", mabillon, l10, p_mabillon);
var odeon_m10b = new Station("odeon/M10B", odeon, l10, p_odeon);
var cluny_la_sorbonne_m10b = new Station("cluny_la_sorbonne/M10B", cluny_la_sorbonne, l10, p_cluny_la_sorbonne);
var maubert_mutualite_m10b = new Station("maubert_mutualite/M10B", maubert_mutualite, l10, p_maubert_mutualite);
var cardinal_lemoine_m10b = new Station("cardinal_lemoine/M10B", cardinal_lemoine, l10, p_cardinal_lemoine);
var jussieu_m10b = new Station("jussieu/M10B", jussieu, l10, p_jussieu);
var gare_d_austerlitz_m10b = new Station("gare_d_austerlitz/M10B", gare_d_austerlitz, l10, p_gare_d_austerlitz);

var chatelet_m11 = new Station("chatelet/M11", chatelet, l11, p_chatelet);
var hotel_de_ville_m11 = new Station("hotel_de_ville/M11", hotel_de_ville, l11, p_hotel_de_ville);
var rambuteau_m11 = new Station("rambuteau/M11", rambuteau, l11, p_rambuteau);
var arts_et_metiers_m11 = new Station("arts_et_metiers/M11", arts_et_metiers, l11, p_arts_et_metiers);
var republique_m11 = new Station("republique/M11", republique, l11, p_republique);
var goncourt_m11 = new Station("goncourt/M11", goncourt, l11, p_goncourt);
var belleville_m11 = new Station("belleville/M11", belleville, l11, p_belleville);
var pyrenees_m11 = new Station("pyrenees/M11", pyrenees, l11, p_pyrenees);
var jourdain_m11 = new Station("jourdain/M11", jourdain, l11, p_jourdain);
var place_des_fetes_m11 = new Station("place_des_fetes/M11", place_des_fetes, l11, p_place_des_fetes);
var telegraphe_m11 = new Station("telegraphe/M11", telegraphe, l11, p_telegraphe);
var porte_des_lilas_m11 = new Station("porte_des_lilas/M11", porte_des_lilas, l11, p_porte_des_lilas);
var mairie_des_lilas_m11 = new Station("mairie_des_lilas/M11", mairie_des_lilas, l11, p_mairie_des_lilas);

var front_populaire_m12 = new Station("front_populaire/M12", front_populaire, l12, p_front_populaire);
var porte_de_la_chapelle_m12 = new Station("porte_de_la_chapelle/M12", porte_de_la_chapelle, l12, p_porte_de_la_chapelle);
var marx_dormoy_m12 = new Station("marx_dormoy/M12", marx_dormoy, l12, p_marx_dormoy);
var marcadet_poissonniers_m12 = new Station("marcadet_poissonniers/M12", marcadet_poissonniers, l12, p_marcadet_poissonniers);
var jules_joffrin_m12 = new Station("jules_joffrin/M12", jules_joffrin, l12, p_jules_joffrin);
var lamarck_caulaincourt_m12 = new Station("lamarck_caulaincourt/M12", lamarck_caulaincourt, l12, p_lamarck_caulaincourt);
var abbesses_m12 = new Station("abbesses/M12", abbesses, l12, p_abbesses);
var pigalle_m12 = new Station("pigalle/M12", pigalle, l12, p_pigalle);
var saint_georges_m12 = new Station("saint_georges/M12", saint_georges, l12, p_saint_georges);
var notre_dame_de_lorette_m12 = new Station("notre_dame_de_lorette/M12", notre_dame_de_lorette, l12, p_notre_dame_de_lorette);
var trinite_d_estienne_d_orves_m12 = new Station("trinite_d_estienne_d_orves/M12", trinite_d_estienne_d_orves, l12, p_trinite_d_estienne_d_orves);
var saint_lazare_m12 = new Station("saint_lazare/M12", saint_lazare, l12, p_saint_lazare);
var madeleine_m12 = new Station("madeleine/M12", madeleine, l12, p_madeleine);
var concorde_m12 = new Station("concorde/M12", concorde, l12, p_concorde);
var assemblee_nationale_m12 = new Station("assemblee_nationale/M12", assemblee_nationale, l12, p_assemblee_nationale);
var solferino_m12 = new Station("solferino/M12", solferino, l12, p_solferino);
var rue_du_bac_m12 = new Station("rue_du_bac/M12", rue_du_bac, l12, p_rue_du_bac);
var sevres_babylone_m12 = new Station("sevres_babylone/M12", sevres_babylone, l12, p_sevres_babylone);
var rennes_m12 = new Station("rennes/M12", rennes, l12, p_rennes);
var notre_dame_des_champs_m12 = new Station("notre_dame_des_champs/M12", notre_dame_des_champs, l12, p_notre_dame_des_champs);
var montparnasse_bienvenue_m12 = new Station("montparnasse_bienvenue/M12", montparnasse_bienvenue, l12, p_montparnasse_bienvenue);
var falguiere_m12 = new Station("falguiere/M12", falguiere, l12, p_falguiere);
var pasteur_m12 = new Station("pasteur/M12", pasteur, l12, p_pasteur);
var volontaires_m12 = new Station("volontaires/M12", volontaires, l12, p_volontaires);
var vaugirard_m12 = new Station("vaugirard/M12", vaugirard, l12, p_vaugirard);
var convention_m12 = new Station("convention/M12", convention, l12, p_convention);
var porte_de_versailles_m12 = new Station("porte_de_versailles/M12", porte_de_versailles, l12, p_porte_de_versailles);
var corentin_celton_m12 = new Station("corentin_celton/M12", corentin_celton, l12, p_corentin_celton);
var mairie_d_issy_m12 = new Station("mairie_d_issy/M12", mairie_d_issy, l12, p_mairie_d_issy);

var asnieres_gennevilliers_les_courtilles_m13a = new Station("asnieres_gennevilliers_les_courtilles/M13A", asnieres_gennevilliers_les_courtilles, l13, p_asnieres_gennevilliers_les_courtilles);
var les_agnettes_m13a = new Station("les_agnettes/M13A", les_agnettes, l13, p_les_agnettes);
var gabriel_peri_m13a = new Station("gabriel_peri/M13A", gabriel_peri, l13, p_gabriel_peri);
var mairie_de_clichy_m13a = new Station("mairie_de_clichy/M13A", mairie_de_clichy, l13, p_mairie_de_clichy);
var porte_de_clichy_m13a = new Station("porte_de_clichy/M13A", porte_de_clichy, l13, p_porte_de_clichy);
var brochant_m13a = new Station("brochant/M13A", brochant, l13, p_brochant);
var la_fourche_m13a = new Station("la_fourche/M13A", la_fourche, l13, p_la_fourche);
var place_de_clichy_m13a = new Station("place_de_clichy/M13A", place_de_clichy, l13, p_place_de_clichy);
var liege_m13a = new Station("liege/M13A", liege, l13, p_liege);
var saint_lazare_m13a = new Station("saint_lazare/M13A", saint_lazare, l13, p_saint_lazare);
var miromesnil_m13a = new Station("miromesnil/M13A", miromesnil, l13, p_miromesnil);
var champs_elysees_clemenceau_m13a = new Station("champs_elysees_clemenceau/M13A", champs_elysees_clemenceau, l13, p_champs_elysees_clemenceau);
var invalides_m13a = new Station("invalides/M13A", invalides, l13, p_invalides);
var varenne_m13a = new Station("varenne/M13A", varenne, l13, p_varenne);
var saint_francois_xavier_m13a = new Station("saint_francois_xavier/M13A", saint_francois_xavier, l13, p_saint_francois_xavier);
var duroc_m13a = new Station("duroc/M13A", duroc, l13, p_duroc);
var montparnasse_bienvenue_m13a = new Station("montparnasse_bienvenue/M13A", montparnasse_bienvenue, l13, p_montparnasse_bienvenue);
var gaite_m13a = new Station("gaite/M13A", gaite, l13, p_gaite);
var pernety_m13a = new Station("pernety/M13A", pernety, l13, p_pernety);
var plaisance_m13a = new Station("plaisance/M13A", plaisance, l13, p_plaisance);
var porte_de_vanves_m13a = new Station("porte_de_vanves/M13A", porte_de_vanves, l13, p_porte_de_vanves);
var malakoff_plateau_de_vanves_m13a = new Station("malakoff_plateau_de_vanves/M13A", malakoff_plateau_de_vanves, l13, p_malakoff_plateau_de_vanves);
var malakoff_rue_etienne_dolet_m13a = new Station("malakoff_rue_etienne_dolet/M13A", malakoff_rue_etienne_dolet, l13, p_malakoff_rue_etienne_dolet);
var chatillon_montrouge_m13a = new Station("chatillon_montrouge/M13A", chatillon_montrouge, l13, p_chatillon_montrouge);

var saint_denis_universite_m13b = new Station("saint_denis_universite/M13B", saint_denis_universite, l13, p_saint_denis_universite);
var basilique_de_saint_denis_m13b = new Station("basilique_de_saint_denis/M13B", basilique_de_saint_denis, l13, p_basilique_de_saint_denis);
var saint_denis_porte_de_paris_m13b = new Station("saint_denis_porte_de_paris/M13B", saint_denis_porte_de_paris, l13, p_saint_denis_porte_de_paris);
var carrefour_pleyel_m13b = new Station("carrefour_pleyel/M13B", carrefour_pleyel, l13, p_carrefour_pleyel);
var mairie_de_saint_ouen_m13b = new Station("mairie_de_saint_ouen/M13B", mairie_de_saint_ouen, l13, p_mairie_de_saint_ouen);
var garibaldi_m13b = new Station("garibaldi/M13B", garibaldi, l13, p_garibaldi);
var porte_de_saint_ouen_m13b = new Station("porte_de_saint_ouen/M13B", porte_de_saint_ouen, l13, p_porte_de_saint_ouen);
var guy_moquet_m13b = new Station("guy_moquet/M13B", guy_moquet, l13, p_guy_moquet);
var la_fourche_m13b = new Station("la_fourche/M13B", la_fourche, l13, p_la_fourche);
var place_de_clichy_m13b = new Station("place_de_clichy/M13B", place_de_clichy, l13, p_place_de_clichy);
var liege_m13b = new Station("liege/M13B", liege, l13, p_liege);
var saint_lazare_m13b = new Station("saint_lazare/M13B", saint_lazare, l13, p_saint_lazare);
var miromesnil_m13b = new Station("miromesnil/M13B", miromesnil, l13, p_miromesnil);
var champs_elysees_clemenceau_m13b = new Station("champs_elysees_clemenceau/M13B", champs_elysees_clemenceau, l13, p_champs_elysees_clemenceau);
var invalides_m13b = new Station("invalides/M13B", invalides, l13, p_invalides);
var varenne_m13b = new Station("varenne/M13B", varenne, l13, p_varenne);
var saint_francois_xavier_m13b = new Station("saint_francois_xavier/M13B", saint_francois_xavier, l13, p_saint_francois_xavier);
var duroc_m13b = new Station("duroc/M13B", duroc, l13, p_duroc);
var montparnasse_bienvenue_m13b = new Station("montparnasse_bienvenue/M13B", montparnasse_bienvenue, l13, p_montparnasse_bienvenue);
var gaite_m13b = new Station("gaite/M13B", gaite, l13, p_gaite);
var pernety_m13b = new Station("pernety/M13B", pernety, l13, p_pernety);
var plaisance_m13b = new Station("plaisance/M13B", plaisance, l13, p_plaisance);
var porte_de_vanves_m13b = new Station("porte_de_vanves/M13B", porte_de_vanves, l13, p_porte_de_vanves);
var malakoff_plateau_de_vanves_m13b = new Station("malakoff_plateau_de_vanves/M13B", malakoff_plateau_de_vanves, l13, p_malakoff_plateau_de_vanves);
var malakoff_rue_etienne_dolet_m13b = new Station("malakoff_rue_etienne_dolet/M13B", malakoff_rue_etienne_dolet, l13, p_malakoff_rue_etienne_dolet);
var chatillon_montrouge_m13b = new Station("chatillon_montrouge/M13B", chatillon_montrouge, l13, p_chatillon_montrouge);

var saint_lazare_m14 = new Station("saint_lazare/M14", saint_lazare, l14, p_saint_lazare);
var madeleine_m14 = new Station("madeleine/M14", madeleine, l14, p_madeleine);
var pyramides_m14 = new Station("pyramides/M14", pyramides, l14, p_pyramides);
var chatelet_m14 = new Station("chatelet/M14", chatelet, l14, p_chatelet);
var gare_de_lyon_m14 = new Station("gare_de_lyon/M14", gare_de_lyon, l14, p_gare_de_lyon);
var bercy_m14 = new Station("bercy/M14", bercy, l14, p_bercy);
var cour_saint_emilion_m14 = new Station("cour_saint_emilion/M14", cour_saint_emilion, l14, p_cour_saint_emilion);
var bibliotheque_francois_mitterrand_m14 = new Station("bibliotheque_francois_mitterrand/M14", bibliotheque_francois_mitterrand, l14, p_bibliotheque_francois_mitterrand);
var olympiades_m14 = new Station("olympiades/M14", olympiades, l14, p_olympiades);
...
var m1 = new Ligne(l1, "rgb(242, 201, 49)", [la_defense_m1, esplanade_de_la_defense_m1, pont_de_neuilly_m1, les_sablons_m1, porte_maillot_m1, argentine_m1, charles_de_gaulle_etoile_m1, georges_v_m1, franklin_d_roosevelt_m1, champs_elysees_clemenceau_m1, concorde_m1, tuileries_m1, palais_royal_musee_du_louvre_m1, louvre_rivoli_m1, chatelet_m1, hotel_de_ville_m1, saint_paul_m1, bastille_m1, gare_de_lyon_m1, reuilly_diderot_m1, nation_m1, porte_de_vincennes_m1, saint_mande_m1, berault_m1, chateau_de_vincennes_m1]);
var m2 = new Ligne(l2, "rgb(33, 110, 180)", [porte_dauphine_m2, victor_hugo_m2, charles_de_gaulle_etoile_m2, ternes_m2, courcelles_m2, monceau_m2, villiers_m2, rome_m2, place_de_clichy_m2, blanche_m2, pigalle_m2, anvers_m2, barbes_rochechouart_m2, la_chapelle_m2, stalingrad_m2, jaures_m2, colonel_fabien_m2, belleville_m2, couronnes_m2, menilmontant_m2, pere_lachaise_m2, philippe_auguste_m2, alexandre_dumas_m2, avron_m2, nation_m2]);
var m3 = new Ligne(l3, "rgb(154, 153, 64)", [pont_de_levallois_becon_m3, anatole_france_m3, louise_michel_m3, porte_de_champerret_m3, pereire_m3, wagram_m3, malesherbes_m3, villiers_m3, europe_m3, saint_lazare_m3, havre_caumartin_m3, opera_m3, quatre_septembre_m3, bourse_m3, sentier_m3, reaumur_sebastopol_m3, arts_et_metiers_m3, temple_m3, republique_m3, parmentier_m3, rue_saint_maur_m3, pere_lachaise_m3, gambetta_m3, porte_de_bagnolet_m3, gallieni_m3]);
var m3bis = new Ligne(l3bis, "rgb(137, 199, 214)", [gambetta_m3b, pelleport_m3b, saint_fargeau_m3b, porte_des_lilas_m3b]);
var m4 = new Ligne(l4, "rgb(187, 77, 152)", [porte_de_clignancourt_m4, simplon_m4, marcadet_poissonniers_m4, chateau_rouge_m4, barbes_rochechouart_m4, gare_du_nord_m4, gare_de_l_est_m4, chateau_d_eau_m4, strasbourg_saint_denis_m4, reaumur_sebastopol_m4, etienne_marcel_m4, les_halles_m4, chatelet_m4, cite_m4, saint_michel_m4, odeon_m4, saint_germain_des_pres_m4, saint_sulpice_m4, saint_placide_m4, montparnasse_bienvenue_m4, valvin_m4, raspail_m4, denfert_rochereau_m4, mouton_duvernet_m4, alesia_m4, porte_d_orleans_m4, mairie_de_montrouge_m4]);
var m5 = new Ligne(l5, "rgb(222, 139, 83)", [bobigny_pablo_picasso_m5, bobigny_pantin_raymond_queneau_m5, eglise_de_pantin_m5, hoche_m5, porte_de_pantin_m5, ourcq_m5, laumiere_m5, jaures_m5, stalingrad_m5, gare_du_nord_m5, gare_de_l_est_m5, jacques_bonsergent_m5, republique_m5, oberkampf_m5, richard_lenoir_m5, breguet_sabin_m5, bastille_m5, quai_de_la_rapee_m5, gare_d_austerlitz_m5, saint_marcel_m5, campo_formio_m5, place_d_italie_m5]);
var m6 = new Ligne(l6, "rgb(121, 187, 146)", [charles_de_gaulle_etoile_m6, kleber_m6, boissiere_m6, trocadero_m6, passy_m6, bir_hakeim_m6, dupleix_m6, la_motte_picquet_grenelle_m6, cambronne_m6, sevres_lecourbe_m6, pasteur_m6, montparnasse_bienvenue_m6, edgar_quinet_m6, raspail_m6, denfert_rochereau_m6, saint_jacques_m6, glaciere_m6, corvisart_m6, place_d_italie_m6, nationale_m6, chevaleret_m6, quai_de_la_gare_m6, bercy_m6, dugommier_m6, daumesnil_m6, bel_air_m6, picpus_m6, nation_m6]);
var m7a = new Ligne(l7, "rgb(223, 154, 177)", [la_courneuve_8_mai_1945_m7a, fort_d_aubervilliers_m7a, aubervilliers_pantin_quatre_chemins_m7a, porte_de_la_villette_m7a, corentin_cariou_m7a, crimee_m7a, riquet_m7a, stalingrad_m7a, louis_blanc_m7a, chateau_landon_m7a, gare_de_l_est_m7a, poissonniere_m7a, cadet_m7a, le_peletier_m7a, chaussee_d_antin_la_fayette_m7a, opera_m7a, pyramides_m7a, palais_royal_musee_du_louvre_m7a, pont_neuf_m7a, chatelet_m7a, pont_marie_m7a, sully_morland_m7a, jussieu_m7a, place_monge_m7a, censier_daubenton_m7a, les_gobelins_m7a, place_d_italie_m7a, tolbiac_m7a, maison_blanche_m7a, le_kremlin_bicetre_m7a, villejuif_leo_lagrange_m7a, villejuif_paul_vaillant_couturier_m7a, villejuif_louis_aragon_m7a]);
var m7b = new Ligne(l7, "rgb(223, 154, 177)", [la_courneuve_8_mai_1945_m7b, fort_d_aubervilliers_m7b, aubervilliers_pantin_quatre_chemins_m7b, porte_de_la_villette_m7b, corentin_cariou_m7b, crimee_m7b, riquet_m7b, stalingrad_m7b, louis_blanc_m7b, chateau_landon_m7b, gare_de_l_est_m7b, poissonniere_m7b, cadet_m7b, le_peletier_m7b, chaussee_d_antin_la_fayette_m7b, opera_m7b, pyramides_m7b, palais_royal_musee_du_louvre_m7b, pont_neuf_m7b, chatelet_m7b, pont_marie_m7b, sully_morland_m7b, jussieu_m7b, place_monge_m7b, censier_daubenton_m7b, les_gobelins_m7b, place_d_italie_m7b, tolbiac_m7b, maison_blanche_m7b, porte_d_italie_m7b, porte_de_choisy_m7b, porte_d_ivry_m7b, pierre_et_marie_curie_m7b, mairie_d_ivry_m7b]);
var m7bisa = new Ligne(l7bis, "rgb(121, 187, 146)", [louis_blanc_m7bisa, jaures_m7bisa, bolivar_m7bisa, buttes_chaumont_m7bisa, botzaris_m7bisa, place_des_fetes_m7bisa, pre_saint_gervais_m7bisa]);
var m7bisb = new Ligne(l7bis, "rgb(121, 187, 146)", [louis_blanc_m7bisb, jaures_m7bisb, bolivar_m7bisb, buttes_chaumont_m7bisb, botzaris_m7bisb, danube_m7bisb, pre_saint_gervais_m7bisb]);
var m8 = new Ligne(l8, "rgb(197, 163, 202)", [balard_m8, lourmel_m8, boucicaut_m8, felix_faure_m8, commerce_m8, la_motte_picquet_grenelle_m8, ecole_militaire_m8, la_tour_maubourg_m8, invalides_m8, concorde_m8, madeleine_m8, opera_m8, richelieu_drouot_m8, grands_boulevards_m8, bonne_nouvelle_m8, strasbourg_saint_denis_m8, republique_m8, filles_du_calvaire_m8, saint_sebastien_froissart_m8, chemin_vert_m8, bastille_m8, ledru_rollin_m8, faidherbe_chaligny_m8, reuilly_diderot_m8, montgallet_m8, daumesnil_m8, michel_bizot_m8, porte_doree_m8, porte_de_charenton_m8, liberte_m8, charenton_ecoles_m8, ecole_veterinaire_de_maisons_alfort_m8, maisons_alfort_stade_m8, maisons_alfort_les_juilliottes_m8, creteil_l_echat_m8, creteil_universite_m8, creteil_prefecture_m8, pointe_du_lac_m8]);
var m9 = new Ligne(l9, "rgb(206, 201, 43)", [pont_de_sevres_m9, billancourt_m9, marcel_sembat_m9, porte_de_saint_cloud_m9, exelmans_m9, michel_ange_molitor_m9, michel_ange_auteuil_m9, jasmin_m9, ranelagh_m9, la_muette_m9, rue_de_la_pompe_m9, trocadero_m9, iena_m9, alma_marceau_m9, franklin_d_roosevelt_m9, saint_philippe_du_roule_m9, miromesnil_m9, saint_augustin_m9, havre_caumartin_m9, chaussee_d_antin_la_fayette_m9, richelieu_drouot_m9, grands_boulevards_m9, bonne_nouvelle_m9, strasbourg_saint_denis_m9, republique_m9, oberkampf_m9, saint_ambroise_m9, voltaire_m9, charonne_m9, rue_des_boulets_m9, nation_m9, buzenval_m9, maraichers_m9, porte_de_montreuil_m9, robespierre_m9, croix_de_chavaux_m9, mairie_de_montreuil_m9]);
var m10a = new Ligne(l10, "rgb(223, 176, 57)", [boulogne_pont_de_saint_cloud_m10a, boulogne_jean_jaures_m10a, michel_ange_molitor_m10a, chardon_lagache_m10a, mirabeau_m10a, javel_andre_citroen_m10a, charles_michels_m10a, avenue_emile_zola_m10a, la_motte_picquet_grenelle_m10a, segur_m10a, duroc_m10a, vaneau_m10a, sevres_babylone_m10a, mabillon_m10a, odeon_m10a, cluny_la_sorbonne_m10a, maubert_mutualite_m10a, cardinal_lemoine_m10a, jussieu_m10a, gare_d_austerlitz_m10a]);
var m10b = new Ligne(l10, "rgb(223, 176, 57)", [boulogne_pont_de_saint_cloud_m10b, boulogne_jean_jaures_m10b, porte_d_auteuil_m10b, michel_ange_auteuil_m10b, eglise_d_auteuil_m10b, javel_andre_citroen_m10b, charles_michels_m10b, avenue_emile_zola_m10b, la_motte_picquet_grenelle_m10b, segur_m10b, duroc_m10b, vaneau_m10b, sevres_babylone_m10b, mabillon_m10b, odeon_m10b, cluny_la_sorbonne_m10b, maubert_mutualite_m10b, cardinal_lemoine_m10b, jussieu_m10b, gare_d_austerlitz_m10a]);
var m11 = new Ligne(l11, "rgb(142, 101, 56)", [chatelet_m11, hotel_de_ville_m11, rambuteau_m11, arts_et_metiers_m11, republique_m11, goncourt_m11, belleville_m11, pyrenees_m11, jourdain_m11, place_des_fetes_m11, telegraphe_m11, porte_des_lilas_m11, mairie_des_lilas_m11]);
var m12 = new Ligne(l12, "rgb(50, 142, 91)", [front_populaire_m12, porte_de_la_chapelle_m12, marx_dormoy_m12, marcadet_poissonniers_m12, jules_joffrin_m12, lamarck_caulaincourt_m12, abbesses_m12, pigalle_m12, saint_georges_m12, notre_dame_de_lorette_m12, trinite_d_estienne_d_orves_m12, saint_lazare_m12, madeleine_m12, concorde_m12, assemblee_nationale_m12, solferino_m12, rue_du_bac_m12, sevres_babylone_m12, rennes_m12, notre_dame_des_champs_m12, montparnasse_bienvenue_m12, falguiere_m12, pasteur_m12, volontaires_m12, vaugirard_m12, convention_m12, porte_de_versailles_m12, corentin_celton_m12, mairie_d_issy_m12]);
var m13a = new Ligne(l13, "rgb(137, 199, 214)", [asnieres_gennevilliers_les_courtilles_m13a, les_agnettes_m13a, gabriel_peri_m13a, mairie_de_clichy_m13a, porte_de_clichy_m13a, brochant_m13a, la_fourche_m13a, place_de_clichy_m13a, liege_m13a, saint_lazare_m13a, miromesnil_m13a, champs_elysees_clemenceau_m13a, invalides_m13a, varenne_m13a, saint_francois_xavier_m13a, duroc_m13a, montparnasse_bienvenue_m13a, gaite_m13a, pernety_m13a, plaisance_m13a, porte_de_vanves_m13a, malakoff_plateau_de_vanves_m13a, malakoff_rue_etienne_dolet_m13a, chatillon_montrouge_m13a]);
var m13b = new Ligne(l13, "rgb(137, 199, 214)", [saint_denis_universite_m13b, basilique_de_saint_denis_m13b, saint_denis_porte_de_paris_m13b, carrefour_pleyel_m13b, mairie_de_saint_ouen_m13b, garibaldi_m13b, porte_de_saint_ouen_m13b, guy_moquet_m13b, la_fourche_m13b, place_de_clichy_m13b, liege_m13b, saint_lazare_m13b, miromesnil_m13b, champs_elysees_clemenceau_m13b, invalides_m13b, varenne_m13b, saint_francois_xavier_m13b, duroc_m13b, montparnasse_bienvenue_m13b, gaite_m13b, pernety_m13b, plaisance_m13b, porte_de_vanves_m13b, malakoff_plateau_de_vanves_m13b, malakoff_rue_etienne_dolet_m13b, chatillon_montrouge_m13b]);
var m14 = new Ligne(l4, "rgb(103, 50, 142)", [saint_lazare_m14, madeleine_m14, pyramides_m14, chatelet_m14, gare_de_lyon_m14, bercy_m14, cour_saint_emilion_m14, bibliotheque_francois_mitterrand_m14, olympiades_m14]);
