...
var p_la_defense = [592*u,1414*u,20*u,0*u];
var p_esplanade_de_la_defense = [670*u,1492*u,20*u,0*u];
var p_pont_de_neuilly = [752*u,1575*u,20*u,0*u];
var p_les_sablons = [835*u,1658*u,20*u,0*u];
var p_porte_maillot = [928*u,1752*u,20*u,0*u];
var p_argentine = [1062*u,1885*u,20*u,0*u];
var p_charles_de_gaulle_etoile = [1166*u,1989*u,20*u,0*u];
var p_georges_v = [1294*u,2117*u,20*u,0*u];
var p_franklin_d_roosevelt = [1418*u,2240*u,-175*u,0*u];
var p_champs_elysees_clemenceau = [1507*u,2330*u,-125*u,25*u];
var p_concorde = [1583*u,2406*u,20*u,0*u];
var p_tuileries = [1774*u,2465*u,20*u,-10*u];
var p_palais_royal_musee_du_louvre = [1953*u,2465*u,-100*u,30*u];
var p_louvre_rivoli = [2099*u,2465*u,20*u,-10*u];
var p_chatelet = [2420*u,2476*u,15*u,-15*u];
var p_hotel_de_ville = [2599*u,2465*u,20*u,0*u];
var p_saint_paul = [2747*u,2616*u,20*u,0*u];
var p_bastille = [2940*u,2664*u,20*u,0*u];
var p_gare_de_lyon = [3124*u,3050*u,20*u,10*u];
var p_reuilly_diderot = [3332*u,2923*u,20*u,7*u];
var p_nation = [3600*u,2776*u,-60*u,0*u];
var p_porte_de_vincennes = [3773*u,2830*u,20*u,0*u];
var p_saint_mande = [3904*u,2904*u,20*u,0*u];
var p_berault = [3999*u,3000*u,20*u,0*u];
var p_chateau_de_vincennes = [4036*u,3035*u,20*u,0*u];
var p_porte_dauphine = [798*u,2008*u,20*u,0*u];
var p_victor_hugo = [951*u,2161*u,-100*u,20*u];
var p_ternes = [1279*u,1876*u,20*u,0*u];
var p_courcelles = [1376*u,1779*u,20*u,0*u];
var p_monceau = [1473*u,1683*u,20*u,0*u];
var p_villiers = [1569*u,1586*u,20*u,0*u];
var p_rome = [1677*u,1478*u,20*u,20*u];
var p_place_de_clichy = [1812*u,1448*u,20*u,-10*u];
var p_blanche = [2030*u,1448*u,20*u,-10*u];
var p_pigalle = [2251*u,1448*u,20*u,-10*u];
var p_anvers = [2418*u,1448*u,20*u,-10*u];
var p_barbes_rochechouart = [2619*u,1448*u,20*u,-10*u];
var p_la_chapelle = [2835*u,1448*u,20*u,-10*u];
var p_stalingrad = [3089*u,1481*u,20*u,0*u];
var p_jaures = [3193*u,1553*u,20*u,0*u];
var p_colonel_fabien = [3211*u,1708*u,20*u,0*u];
var p_belleville = [3211*u,1857*u,20*u,10*u];
var p_couronnes = [3304*u,1982*u,20*u,0*u];
var p_menilmontant = [3420*u,2097*u,20*u,0*u];
var p_pere_lachaise = [3528*u,2238*u,15*u,-15*u];
var p_philippe_auguste = [3528*u,2356*u,20*u,0*u];
var p_alexandre_dumas = [3528*u,2503*u,20*u,0*u];
var p_avron = [3542*u,2652*u,20*u,0*u];
var p_pont_de_levallois_becon = [1158*u,1174*u,20*u,0*u];
var p_anatole_france = [1211*u,1227*u,20*u,0*u];
var p_louise_michel = [1263*u,1279*u,20*u,0*u];
var p_porte_de_champerret = [1316*u,1332*u,20*u,0*u];
var p_pereire = [1393*u,1409*u,20*u,0*u];
var p_wagram = [1446*u,1462*u,20*u,0*u];
var p_malesherbes = [1507*u,1523*u,20*u,0*u];
var p_europe = [1680*u,1697*u,20*u,0*u];
var p_saint_lazare = [1801*u,1862*u,20*u,10*u];
var p_havre_caumartin = [1868*u,2017*u,20*u,0*u];
var p_opera = [1957*u,2106*u,20*u,10*u];
var p_quatre_septembre = [2059*u,2207*u,20*u,0*u];
var p_bourse = [2210*u,2260*u,20*u,-10*u];
var p_sentier = [2368*u,2260*u,20*u,-10*u];
var p_reaumur_sebastopol = [2575*u,2271*u,20*u,15*u];
var p_arts_et_metiers = [2825*u,2226*u,-100*u,-20*u];
var p_temple = [2895*u,2141*u,-70*u,0*u];
var p_republique = [2969*u,2098*u,20*u,-1*u];
var p_parmentier = [3313*u,2180*u,20*u,0*u];
var p_rue_saint_maur = [3404*u,2238*u,-30*u,30*u];
var p_gambetta = [3708*u,2238*u,-30*u,30*u];
var p_porte_de_bagnolet = [3890*u,2238*u,-40*u,-20*u];
var p_gallieni = [4021*u,2238*u,-20*u,-20*u];
var p_pelleport = [3819*u,2078*u,20*u,0*u];
var p_saint_fargeau = [3910*u,1931*u,20*u,0*u];
var p_porte_des_lilas = [3910*u,1790*u,20*u,0*u];
var p_porte_de_clignancourt = [2367*u,1074*u,20*u,0*u];
var p_simplon = [2434*u,1141*u,20*u,0*u];
var p_marcadet_poissonniers = [2498*u,1243*u,20*u,15*u];
var p_chateau_rouge = [2498*u,1332*u,20*u,10*u];
var p_gare_du_nord = [2840*u,1547*u,20*u,15*u];
var p_gare_de_l_est = [2840*u,1718*u,20*u,10*u];
var p_chateau_d_eau = [2721*u,1833*u,20*u,0*u];
var p_strasbourg_saint_denis = [2675*u,2038*u,20*u,-5*u];
var p_etienne_marcel = [2421*u,2304*u,20*u,20*u];
var p_les_halles = [2421*u,2387*u,20*u,0*u];
var p_cite = [2352*u,2605*u,20*u,0*u];
var p_saint_michel = [2293*u,2766*u,20*u,0*u];
var p_odeon = [2260*u,2852*u,20*u,-10*u];
var p_saint_germain_des_pres = [2078*u,2840*u,-80*u,-20*u];
var p_saint_sulpice = [2028*u,2957*u,20*u,0*u];
var p_saint_placide = [2028*u,3100*u,-110*u,5*u];
var p_montparnasse_bienvenue = [2005*u,3255*u,35*u,-20*u];
var p_valvin = [2158*u,3254*u,20*u,0*u];
var p_raspail = [2263*u,3315*u,20*u,0*u];
var p_denfert_rochereau = [2326*u,3392*u,20*u,0*u];
var p_mouton_duvernet = [2326*u,3531*u,10*u,20*u];
var p_alesia = [2257*u,3681*u,20*u,0*u];
var p_porte_d_orleans = [2198*u,3739*u,20*u,0*u];
var p_mairie_de_montrouge = [2198*u,3851*u,20*u,0*u];
var p_bobigny_pablo_picasso = [4024*u,1133*u,20*u,0*u];
var p_bobigny_pantin_raymond_queneau = [3909*u,1247*u,20*u,0*u];
var p_eglise_de_pantin = [3832*u,1324*u,20*u,0*u];
var p_hoche = [3722*u,1387*u,20*u,10*u];
var p_porte_de_pantin = [3563*u,1387*u,20*u,-10*u];
var p_ourcq = [3405*u,1387*u,20*u,-10*u];
var p_laumiere = [3283*u,1462*u,20*u,10*u];
var p_jacques_bonsergent = [2895*u,1921*u,20*u,0*u];
var p_oberkampf = [3061*u,2175*u,20*u,0*u];
var p_richard_lenoir = [3127*u,2427*u,15*u,0*u];
var p_breguet_sabin = [3033*u,2520*u,20*u,0*u];
var p_quai_de_la_rapee = [2938*u,2968*u,-140*u,0*u];
var p_gare_d_austerlitz = [2938*u,3173*u,20*u,0*u];
var p_saint_marcel = [2938*u,3294*u,20*u,0*u];
var p_campo_formio = [2869*u,3386*u,20*u,0*u];
var p_place_d_italie = [2779*u,3543*u,20*u,-10*u];
var p_kleber = [1038*u,2149*u,20*u,0*u];
var p_boissiere = [905*u,2281*u,20*u,0*u];
var p_passy = [909*u,2696*u,20*u,0*u];
var p_bir_hakeim = [1034*u,2819*u,20*u,0*u];
var p_dupleix = [1142*u,2926*u,20*u,0*u];
var p_la_motte_picquet_grenelle = [1293*u,3045*u,20*u,0*u];
var p_cambronne = [1500*u,3091*u,20*u,0*u];
var p_sevres_lecourbe = [1609*u,3214*u,20*u,0*u];
var p_pasteur = [1767*u,3278*u,20*u,20*u];
var p_edgar_quinet = [2075*u,3275*u,-50*u,30*u];
var p_saint_jacques = [2416*u,3483*u,20*u,0*u];
var p_glaciere = [2531*u,3541*u,20*u,-10*u];
var p_corvisart = [2663*u,3542*u,20*u,-10*u];
var p_nationale = [2922*u,3542*u,20*u,-10*u];
var p_chevaleret = [3062*u,3542*u,20*u,10*u];
var p_quai_de_la_gare = [3200*u,3481*u,20*u,0*u];
var p_bercy = [3351*u,3329*u,20*u,0*u];
var p_dugommier = [3442*u,3239*u,20*u,0*u];
var p_daumesnil = [3545*u,3136*u,20*u,0*u];
var p_bel_air = [3625*u,3054*u,20*u,0*u];
var p_picpus = [3707*u,2974*u,20*u,0*u];
var p_la_courneuve_8_mai_1945 = [3548*u,800*u,20*u,0*u];
var p_fort_d_aubervilliers = [3548*u,928*u,20*u,0*u];
var p_aubervilliers_pantin_quatre_chemins = [3439*u,1068*u,20*u,0*u];
var p_porte_de_la_villette = [3337*u,1170*u,20*u,0*u];
var p_corentin_cariou = [3255*u,1251*u,20*u,0*u];
var p_crimee = [3190*u,1316*u,20*u,0*u];
var p_riquet = [3124*u,1383*u,20*u,0*u];
var p_louis_blanc = [3058*u,1580*u,20*u,20*u];
var p_chateau_landon = [2981*u,1655*u,20*u,0*u];
var p_poissonniere = [2530*u,1717*u,20*u,-10*u];
var p_cadet = [2317*u,1750*u,10*u,-20*u];
var p_le_peletier = [2244*u,1824*u,20*u,0*u];
var p_chaussee_d_antin_la_fayette = [2058*u,2016*u,20*u,-5*u];
var p_pyramides = [1953*u,2280*u,20*u,0*u];
var p_pont_neuf = [2218*u,2486*u,20*u,20*u];
var p_pont_marie = [2617*u,2610*u,20*u,0*u];
var p_sully_morland = [2743*u,2763*u,-120*u,0*u];
var p_jussieu = [2685*u,3071*u,20*u,0*u];
var p_place_monge = [2596*u,3166*u,20*u,0*u];
var p_censier_daubenton = [2596*u,3288*u,20*u,0*u];
var p_les_gobelins = [2681*u,3401*u,20*u,0*u];
var p_tolbiac = [2756*u,3635*u,20*u,0*u];
var p_maison_blanche = [2756*u,3720*u,20*u,0*u];
var p_le_kremlin_bicetre = [2756*u,3830*u,20*u,0*u];
var p_villejuif_leo_lagrange = [2756*u,3923*u,20*u,0*u];
var p_villejuif_paul_vaillant_couturier = [2756*u,4017*u,20*u,0*u];
var p_villejuif_louis_aragon = [2756*u,4104*u,20*u,0*u];
var p_porte_d_italie = [2878*u,3796*u,10*u,-10*u];
var p_porte_de_choisy = [3023*u,3796*u,10*u,-10*u];
var p_porte_d_ivry = [3164*u,3796*u,10*u,-10*u];
var p_pierre_et_marie_curie = [3265*u,3843*u,20*u,0*u];
var p_mairie_d_ivry = [3333*u,3912*u,20*u,0*u];
var p_bolivar = [3287*u,1633*u,20*u,-5*u];
var p_buttes_chaumont = [3451*u,1663*u,-20*u,-20*u];
var p_botzaris = [3541*u,1663*u,20*u,5*u];
var p_place_des_fetes = [3669*u,1789*u,-40*u,30*u];
var p_pre_saint_gervais = [3785*u,1646*u,20*u,0*u];
var p_danube = [3669*u,1558*u,20*u,0*u];
var p_balard = [1040*u,3650*u,20*u,0*u];
var p_lourmel = [1157*u,3533*u,20*u,0*u];
var p_boucicaut = [1250*u,3442*u,20*u,0*u];
var p_felix_faure = [1292*u,3315*u,20*u,0*u];
var p_commerce = [1292*u,3194*u,20*u,0*u];
var p_ecole_militaire = [1292*u,2832*u,20*u,0*u];
var p_la_tour_maubourg = [1398*u,2685*u,-140*u,0*u];
var p_invalides = [1507*u,2578*u,20*u,0*u];
var p_madeleine = [1607*u,2256*u,15*u,25*u];
var p_richelieu_drouot = [2183*u,2038*u,5*u,25*u];
var p_grands_boulevards = [2343*u,2038*u,10*u,-20*u];
var p_bonne_nouvelle = [2560*u,2038*u,-20*u,-20*u];
var p_filles_du_calvaire = [2917*u,2292*u,20*u,0*u];
var p_saint_sebastien_froissart = [2917*u,2413*u,-210*u,0*u];
var p_chemin_vert = [2917*u,2529*u,-100*u,0*u];
var p_ledru_rollin = [3041*u,2748*u,20*u,0*u];
var p_faidherbe_chaligny = [3234*u,2826*u,20*u,0*u];
var p_montgallet = [3437*u,3030*u,20*u,0*u];
var p_michel_bizot = [3615*u,3207*u,20*u,0*u];
var p_porte_doree = [3680*u,3304*u,20*u,0*u];
var p_porte_de_charenton = [3589*u,3398*u,20*u,0*u];
var p_liberte = [3657*u,3512*u,20*u,0*u];
var p_charenton_ecoles = [3759*u,3613*u,20*u,0*u];
var p_ecole_veterinaire_de_maisons_alfort = [3858*u,3712*u,20*u,0*u];
var p_maisons_alfort_stade = [3932*u,3791*u,20*u,0*u];
var p_maisons_alfort_les_juilliottes = [3932*u,3871*u,20*u,0*u];
var p_creteil_l_echat = [3932*u,3953*u,20*u,0*u];
var p_creteil_universite = [3932*u,4027*u,20*u,0*u];
var p_creteil_prefecture = [3932*u,4106*u,20*u,0*u];
var p_pointe_du_lac = [3932*u,4183*u,20*u,0*u];
var p_pont_de_sevres = [462*u,3743*u,20*u,0*u];
var p_billancourt = [534*u,3671*u,20*u,0*u];
var p_marcel_sembat = [604*u,3601*u,20*u,0*u];
var p_porte_de_saint_cloud = [674*u,3510*u,20*u,0*u];
var p_exelmans = [674*u,3403*u,20*u,0*u];
var p_michel_ange_molitor = [674*u,3285*u,10*u,30*u];
var p_michel_ange_auteuil = [674*u,3173*u,-175*u,-10*u];
var p_jasmin = [674*u,3000*u,20*u,0*u];
var p_ranelagh = [674*u,2828*u,20*u,0*u];
var p_la_muette = [674*u,2654*u,20*u,0*u];
var p_rue_de_la_pompe = [707*u,2465*u,20*u,-10*u];
var p_trocadero = [895*u,2465*u,20*u,-10*u];
var p_iena = [1075*u,2465*u,20*u,20*u];
...
var p_charonne = [3418*u,2559*u,20*u,0*u];
var p_rue_des_boulets = [3494*u,2637*u,-130*u,20*u];
var p_buzenval = [3729*u,2691*u,20*u,0*u];
var p_maraichers = [3790*u,2631*u,20*u,0*u];
var p_porte_de_montreuil = [3853*u,2566*u,20*u,0*u];
var p_robespierre = [3911*u,2510*u,20*u,0*u];
var p_croix_de_chavaux = [3975*u,2446*u,20*u,0*u];
var p_mairie_de_montreuil = [4035*u,2383*u,20*u,0*u];
var p_boulogne_pont_de_saint_cloud = [389*u,3397*u,20*u,0*u];
var p_boulogne_jean_jaures = [469*u,3317*u,20*u,20*u];
var p_chardon_lagache = [747*u,3286*u,30*u,5*u];
var p_mirabeau = [857*u,3248*u,20*u,0*u];
var p_javel_andre_citroen = [995*u,3170*u,20*u,20*u];
var p_charles_michels = [1121*u,3139*u,20*u,0*u];
var p_avenue_emile_zola = [1191*u,3068*u,-150*u,0*u];
var p_segur = [1566*u,3137*u,20*u,15*u];
var p_duroc = [1712*u,3100*u,20*u,0*u];
var p_vaneau = [1803*u,3009*u,20*u,0*u];
var p_sevres_babylone = [1896*u,2916*u,-150*u,0*u];
var p_mabillon = [2122*u,2861*u,20*u,20*u];
var p_cluny_la_sorbonne = [2376*u,2861*u,20*u,0*u];
var p_maubert_mutualite = [2479*u,2937*u,20*u,0*u];
var p_cardinal_lemoine = [2558*u,3015*u,20*u,0*u];
var p_porte_d_auteuil = [546*u,3239*u,-125*u,0*u];
var p_eglise_d_auteuil = [807*u,3170*u,20*u,-10*u];
var p_rambuteau = [2708*u,2358*u,20*u,0*u];
var p_goncourt = [3099*u,1967*u,20*u,0*u];
var p_pyrenees = [3355*u,1789*u,-20*u,30*u];
var p_jourdain = [3525*u,1789*u,-30*u,30*u];
var p_telegraphe = [3815*u,1789*u,-10*u,30*u];
var p_porte_des_lilas = [3910*u,1789*u,20*u,0*u];
var p_mairie_des_lilas = [4035*u,1651*u,20*u,0*u];
var p_front_populaire = [3001*u,1009*u,20*u,0*u];
var p_porte_de_la_chapelle = [2851*u,1074*u,20*u,10*u];
var p_marx_dormoy = [2851*u,1200*u,20*u,0*u];
var p_jules_joffrin = [2366*u,1242*u,20*u,-10*u];
var p_lamarck_caulaincourt = [2250*u,1260*u,20*u,20*u];
var p_abbesses = [2250*u,1354*u,20*u,0*u];
var p_saint_georges = [2250*u,1611*u,20*u,0*u];
var p_notre_dame_de_lorette = [2200*u,1767*u,-125*u,30*u];
var p_trinite_d_estienne_d_orves = [1983*u,1767*u,-100*u,-15*u];
var p_assemblee_nationale = [1603*u,2624*u,20*u,0*u];
var p_solferino = [1695*u,2718*u,20*u,0*u];
var p_rue_du_bac = [1801*u,2822*u,20*u,0*u];
var p_rennes = [1992*u,3014*u,-60*u,20*u];
var p_notre_dame_des_champs = [2088*u,3152*u,20*u,0*u];
var p_falguiere = [1812*u,3233*u,20*u,-10*u];
var p_volontaires = [1647*u,3397*u,20*u,0*u];
var p_vaugirard = [1540*u,3504*u,20*u,0*u];
var p_convention = [1495*u,3610*u,20*u,0*u];
var p_porte_de_versailles = [1351*u,3694*u,20*u,5*u];
var p_corentin_celton = [1174*u,3872*u,20*u,0*u];
var p_mairie_d_issy = [1051*u,3993*u,20*u,0*u];
var p_asnieres_gennevilliers_les_courtilles = [1174*u,538*u,20*u,0*u];
var p_les_agnettes = [1242*u,743*u,20*u,0*u];
var p_gabriel_peri = [1311*u,811*u,20*u,0*u];
var p_mairie_de_clichy = [1469*u,970*u,20*u,0*u];
var p_porte_de_clichy = [1628*u,1129*u,20*u,0*u];
var p_brochant = [1718*u,1219*u,-75*u,20*u];
var p_la_fourche = [1812*u,1339*u,20*u,0*u];
var p_liege = [1812*u,1608*u,20*u,0*u];
var p_varenne = [1506*u,2748*u,20*u,0*u];
var p_saint_francois_xavier = [1572*u,2958*u,20*u,0*u];
var p_gaite = [2005*u,3420*u,20*u,0*u];
var p_pernety = [1945*u,3520*u,20*u,0*u];
var p_plaisance = [1846*u,3619*u,20*u,0*u];
var p_porte_de_vanves = [1726*u,3739*u,20*u,0*u];
var p_malakoff_plateau_de_vanves = [1669*u,3851*u,20*u,0*u];
var p_malakoff_rue_etienne_dolet = [1669*u,3978*u,20*u,0*u];
var p_chatillon_montrouge = [1669*u,4104*u,20*u,0*u];
var p_saint_denis_universite = [2726*u,494*u,20*u,0*u];
var p_basilique_de_saint_denis = [2646*u,574*u,20*u,0*u];
var p_saint_denis_porte_de_paris = [2376*u,685*u,20*u,10*u];
var p_carrefour_pleyel = [2124*u,743*u,20*u,15*u];
var p_mairie_de_saint_ouen = [2019*u,848*u,20*u,0*u];
var p_garibaldi = [1912*u,956*u,20*u,0*u];
var p_porte_de_saint_ouen = [1812*u,1077*u,20*u,0*u];
var p_guy_moquet = [1812*u,1201*u,20*u,0*u];
var p_cour_saint_emilion = [3410*u,3473*u,20*u,0*u];
var p_bibliotheque_francois_mitterrand = [3325*u,3558*u,20*u,0*u];
var p_olympiades = [3113*u,3637*u,20*u,10*u];
